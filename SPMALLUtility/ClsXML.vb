...
Public Class ClsXML
  ...
  Sub GetChildChildBez(ByVal cControl As Control)
    ...
    Try
      If cControl.Name = "pcAttachments" Then
      ...
      If TypeOf (cControl) Is Label Or TypeOf (cControl) Is LinkLabel Or _
                  ...
                  TypeOf (cControl) Is DevExpress.XtraBars.PopupControlContainer Or _
                  TypeOf (cControl) Is DevExpress.XtraBars.PopupControl Or _
    ...
    Try
      ...
      With frm
        ...
        For Each cControl As Control In frm.Controls
          If cControl.Name = "pcAttachments" Then
            Trace.WriteLine(String.Format("Controling: name: {0}, bez: {1} / Typeof: {2}", _
                                        cControl.Name, cControl.Text, _
                                        cControl.GetType))
          End If
          ...
          If TypeOf (cControl) Is Label Or TypeOf (cControl) Is LinkLabel Or _
            ...
            Else
              ...
              If cControl.HasChildren Then
                For Each ctrl As Object In cControl.Controls
