...
Public Class ClsXML
  ...
  Function CheckForMustFields(ByVal frm As frmPropose) As Boolean
        ...
        For Each con2 As Control In grp.Controls
          ...
          If CInt(Val(liFieldInfo(0))) = 1 Then
            ...
            If liFieldInfo.Length > 1 Then
							frm.ErrorProvider1.SetError(ctrls, m_Translate.GetSafeTranslationValue(liFieldInfo(1)))

            Else
							frm.ErrorProvider1.SetError(ctrls, _
																					If(liFieldInfo.Length > 1, _
																						 m_Translate.GetSafeTranslationValue(liFieldInfo(1)), _
																						 m_Translate.GetSafeTranslationValue("Keine Bezeichnung...")))
            End If
          End If
        Next
