...
Public Class PdfManipulation2
	...
	'	Public Sub New(ByVal pageSize As iTextSharp.text.Rectangle,
	'								 ByVal leftMargin As Single, ByVal rightMargin As Single,
	...
	'''' <remarks></remarks>
	'Public Function RemoveRestrictions(ByVal restrictedPdf As String, Optional ByVal password As String = Nothing, Optional ByVal saveABackup As Boolean = True) As Boolean
	...
	'		'remove restrictions
	'		Dim perms As Integer = iTextSharp.text.pdf.PdfWriter.ALLOW_ASSEMBLY Or
	'													 iTextSharp.text.pdf.PdfWriter.ALLOW_COPY Or
	'													 iTextSharp.text.pdf.PdfWriter.ALLOW_DEGRADED_PRINTING Or
	'													 iTextSharp.text.pdf.PdfWriter.ALLOW_FILL_IN Or
	'													 iTextSharp.text.pdf.PdfWriter.ALLOW_MODIFY_ANNOTATIONS Or
	'													 iTextSharp.text.pdf.PdfWriter.ALLOW_MODIFY_CONTENTS Or
	'													 iTextSharp.text.pdf.PdfWriter.ALLOW_PRINTING Or
	...
	''' <remarks></remarks>
	Public Sub ExtractPdfPages(ByVal sourcePdf As String, ByVal pageNumbersToExtract As List(Of Integer), ByVal outPdf As String)
	...
	''' The actual output pdf file names will be serialized. 
	''' <remarks>The last splitted pdf may not have
	''' the same number of pages as the rest, depending on the combination of number of pages in the source pdf 
	...
	Public Function SplitPdfByPages(ByVal sourcePdf As String, ByVal numOfPages As Integer) As List(Of String)
		Dim raf As iTextSharp.text.pdf.RandomAccessFileOrArray = Nothing
		...
		Try
			...
			Else
				...
				For i As Integer = 1 To n
					'outfile = String.Format(baseNameOutPdf, i)
					Dim tempFileName = System.IO.Path.GetTempFileName()
					tempFileName = System.IO.Path.ChangeExtension(tempFileName, "PDF")

					'outfile = baseNameOutPdf.Replace(ext, "_" & i & ext)
					doc = New iTextSharp.text.Document(reader.GetPageSizeWithRotation(currentPage))
					pdfCpy = New iTextSharp.text.pdf.PdfCopy(doc, New IO.FileStream(tempFileName, IO.FileMode.Create))
					'pdfCpy = New iTextSharp.text.pdf.PdfCopy(doc, New IO.FileStream(outfile, IO.FileMode.Create))
	...
	Public Sub ExtractAndMergePdfPages(ByVal sourceTable As DataTable, ByVal outPdf As String)
	...
	Public Function AddWatermarkImage(ByVal sourceFile As String, ByVal watermarkImage As String) As String
		...
		Try
			...
			stamper = New iTextSharp.text.pdf.PdfStamper(reader, New System.IO.FileStream(tempFileName, IO.FileMode.Create))
	...
	''' <remarks></remarks>
	Public Function AddWatermarkText(ByVal sourceFile As String, ByVal watermarkText() As String,
																		 ...
																		 Optional ByVal watermarkRotation As Single = 45.0F) As String
	...
	Public Function ExportBookmarksToXML(ByVal sourcePdf As String, ByVal outputXML As String) As Boolean
		Dim result As Boolean = False
		Try
			Dim reader As New iTextSharp.text.pdf.PdfReader(sourcePdf)
	...
	Public Function MergePdfFiles(ByVal pdfFiles() As String, ByVal outputPath As String,
																			 Optional ByVal authorName As String = "",
																			 Optional ByVal creatorName As String = "",
	...
	Public Sub AddDocumentOutline(ByVal sourcePdf As String, ByVal outputPdf As String, ByVal outlineTable As System.Data.DataTable)
		Dim raf As iTextSharp.text.pdf.RandomAccessFileOrArray = Nothing
		Dim reader As iTextSharp.text.pdf.PdfReader = Nothing
	...
	Public Function ExtractURLs(ByVal sourcePdf As String, Optional ByVal pageNumbers() As Integer = Nothing) As System.Data.DataTable
	...
	''' <remarks></remarks>
	Public Sub FillAcroForm(ByVal sourcePdf As String, ByVal fieldData As DataRow, ByVal outputPdf As String)
		Try
	...
	Public Sub FillMyForm(ByVal sourcePdf As String, ByVal fieldData As DataRow, ByVal outputPdf As String)
		Try
			'Open the pdf using pdfreader
			Dim reader As New iTextSharp.text.pdf.PdfReader(sourcePdf)
	...
	Public Sub AddTextAnnotation(ByVal sourcePdf As String, ByVal outputPdf As String)
	...
	Public Function GetAcroFieldsData(ByVal sourcePdf As String) As Dictionary(Of String, String)
	...
	Public Function GetPdfSummary(ByVal sourcePdf As String) As DataTable
	...
	Public Function ReplacePagesWithBlank(ByVal sourcePdf As String,
																							 ByVal pagesToReplace As List(Of Integer),
																							 ByVal outPdf As String,
	...
	Public Function InsertPages(ByVal sourcePdf As String,
																		 ByVal pagesToInsert As Dictionary(Of Integer, iTextSharp.text.pdf.PdfImportedPage),
	...
	''' <returns>True if successful, false if failed</returns>
	''' <remarks></remarks>
	Public Function RemovePages(ByVal sourcePdf As String, ByVal pagesToRemove As List(Of Integer), ByVal outputPdf As String) As Boolean
		Dim result As Boolean = False
		Dim reader As iTextSharp.text.pdf.PdfReader = Nothing
		Dim doc As iTextSharp.text.Document = Nothing
		Dim copier As iTextSharp.text.pdf.PdfCopy = Nothing
	...
	Public Sub DrawShapesDemo(ByVal sourcePdf As String, ByVal outputPdf As String)
		Dim reader As iTextSharp.text.pdf.PdfReader = Nothing
		Dim stamper As iTextSharp.text.pdf.PdfStamper = Nothing
		Dim cb As iTextSharp.text.pdf.PdfContentByte = Nothing
		Dim rect As iTextSharp.text.Rectangle = Nothing
	...
	Public Sub AddImageToPage(ByVal sourcePdf As String, ByVal outputPdf As String, ByVal imgPath As String, ByVal imgLocation As Point, ByVal imgSize As Size, Optional ByVal pages() As Integer = Nothing)
		Dim reader As iTextSharp.text.pdf.PdfReader = Nothing
		Dim stamper As iTextSharp.text.pdf.PdfStamper = Nothing
		Dim img As iTextSharp.text.Image = Nothing
		Dim cb As iTextSharp.text.pdf.PdfContentByte = Nothing
	...
	''' myDict.Add(2, 5)
	''' </remarks>
	Public Function ExtractAndInsertPages(ByVal pdfToExtract As String,
																				ByVal pdfToInsert As String,
																				ByVal insertionDetails As Dictionary(Of Integer, Integer),
