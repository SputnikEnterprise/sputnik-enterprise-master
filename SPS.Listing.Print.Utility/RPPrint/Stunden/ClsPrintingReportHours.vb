...
Namespace ReportPrint
	...
	Public Class ClsPrintingReportHours
...
#End Region
	...
	Public Class HoursPrintData
		...
		Public Property CustomerHoursToPrintData As BindingList(Of CustomertReportHoursData)
		Public Property EmployeeHoursToPrintData As BindingList(Of EmployeeReportHoursData)
		Public Property SearchKindEnum As HourSearchTypeEnum
