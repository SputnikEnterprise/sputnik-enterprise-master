...
Public Class ClsLLRPSearchPrint
...
#Region "private fields"
	...
	Private m_printSetting As New ClsLLRPSearchPrintSetting
...
#Region "Constructor"
	...
	Public Sub New(ByVal _setting As SP.Infrastructure.Initialization.InitializeClass, ByVal _PrintSetting As ClsLLRPSearchPrintSetting)
...
#End Region
	...
	Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.m_printSetting.DbConnString2Open, _ClsLLFunc, 0)
		With _ClsLLFunc
	...
	Sub SetLLVariable(ByVal LL As ListLabel)
		...
		LL.Variables.Add("FilterBez2", m_printSetting.ListFilterBez(1))
		LL.Variables.Add("FilterBez3", m_printSetting.ListFilterBez(2))
		LL.Variables.Add("FilterBez4", m_printSetting.ListFilterBez(3))
