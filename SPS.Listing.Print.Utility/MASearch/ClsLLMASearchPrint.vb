...
Public Class ClsLLMASearchPrint
	...
	Sub ShowInDesign()
		...
		Try
			Dim rFoundedrec As SqlDataReader = MainUtilities.OpenDb4PrintListing(strConnString, Me.MAListPrintSetting.SQL2Open)
	...
	Function ShowInPrint(ByRef bShowBox As Boolean) As String
		...
		Try
			Dim rFoundedrec As SqlDataReader = Utilities.OpenDb4PrintListing(strConnString, MAListPrintSetting.SQL2Open)
	...
	Sub SetLLVariable()
		...
		LL.Variables.Add("FilterBez2", MAListPrintSetting.ListFilterBez(1))
		LL.Variables.Add("FilterBez3", MAListPrintSetting.ListFilterBez(2))
		LL.Variables.Add("FilterBez4", MAListPrintSetting.ListFilterBez(3))
