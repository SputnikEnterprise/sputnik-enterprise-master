...
Public Class ClsLLOPSearchPrint
	...
	Private OPListPrintSetting As New ClsLLOPSearchPrintSetting
...
#Region "Constructor"
	...
	Public Sub New(ByVal _Setting As ClsLLOPSearchPrintSetting)
		...
		Me.OPListPrintSetting = _Setting
		Me.strConnString = Me.OPListPrintSetting.DbConnString2Open
...
#End Region
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = OPListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", OPListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.OPListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      ...
      rFoundedrec = MainUtilities.OpenDb4PrintListing(strConnString, Me.OPListPrintSetting.SQL2Open)
      ...
      End If
      If OPListPrintSetting.JobNr2Print <> "7.11" Then
        LL.Variables.Add("KreditInfo", Me.GetKDKreditInfoLine(CInt(rFoundedrec("KDNr").ToString)))
      End If
      SetLLVariable(LL)
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
		...
		Dim strJobNr As String = Me.OPListPrintSetting.JobNr2Print
    Try
    ...
    Dim strQuery As String = OPListPrintSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(OPListPrintSetting.DbConnString2Open)
    Dim i As Integer = 0
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.OPListPrintSetting.DbConnString2Open, _ClsLLFunc, OPListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me.OPListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", OPListPrintSetting.ListSortBez)
    LL.Variables.Add("FilterBez", OPListPrintSetting.ListFilterBez(0))
    LL.Variables.Add("FilterBez2", OPListPrintSetting.ListFilterBez(1))
    LL.Variables.Add("FilterBez3", OPListPrintSetting.ListFilterBez(2))
    LL.Variables.Add("FilterBez4", OPListPrintSetting.ListFilterBez(3))

		LL.Variables.Add("Dokbez", OPListPrintSetting.DocBez)
    LL.Variables.Add("cTotalPayedZE", OPListPrintSetting.TotalOpenBetrag4Date)
    LL.Variables.Add("KreditInfo", String.Empty)

    LL.Variables.Add("dvDate", OPListPrintSetting.FirstDate)
    LL.Variables.Add("dBDate", OPListPrintSetting.LastDate)

    LL.Variables.Add("bGetCreatedOnInsteadFakDate", Me.OPListPrintSetting.bGetCreatedOnInsteadFakDate)
    LL.Variables.Add("bShowFaelligInColumn", Me.OPListPrintSetting.bShowFaelligInColumn)
    LL.Variables.Add("bShow15DayAsFirst", Me.OPListPrintSetting.bShow15DayAsFirst)
		LL.Variables.Add("bHideOPInfoLine", Me.OPListPrintSetting.HideOPInfoLine.GetValueOrDefault(False))
		LL.Variables.Add("bHideRefNrLine", Me.OPListPrintSetting.HideRefNrLine.GetValueOrDefault(False))
		LL.Variables.Add("bHideKreditInfoLine", Me.OPListPrintSetting.HideKreditInfoLine.GetValueOrDefault(False))
  ...
  Private Function GetKDKreditInfoLine(ByVal iKDNr As Integer) As String
    ...
    Try
      ...
      Catch ex As Exception
        MsgBox(ex.ToString, MsgBoxStyle.Critical, "GetKDKreditInfoLine_0")
    ...
    Catch ex As Exception
      MsgBox(ex.ToString, MsgBoxStyle.Critical, "GetKDKreditInfoLine")
