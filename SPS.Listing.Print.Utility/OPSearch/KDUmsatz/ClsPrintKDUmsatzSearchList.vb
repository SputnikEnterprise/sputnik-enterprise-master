...
Namespace KDUmsatzSearchListing

  Public Class ClsPrintKDUmsatzSearchList

		Private _ClsSetting As New ClsLLKDUmsatzSearchPrintSetting

		Public Property PrintData As ClsLLKDUmsatzSearchPrintSetting



    Function PrintKDUmsatzList() As String
      Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
      Dim strResult As String = String.Empty

			Dim _clsPrint As New ClsLLKDUmsatzSearchPrint(_ClsSetting)
