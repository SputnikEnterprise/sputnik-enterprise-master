...
Public Class ClsLLKDUmsatzSearchPrint
  ...
  Private m_md As New Mandant
	Private _ListSetting As New ClsLLKDUmsatzSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = _ListSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", _ListSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me._ListSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      ...
      rFoundedrec = MainUtilities.OpenDb4PrintListing(strConnString, Me._ListSetting.SQL2Open)
      ...
      End If
      SetLLVariable(LL)
			LL.Core.LlDefineLayout(CType(_ListSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel, _
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
		...
		Dim strJobNr As String = Me._ListSetting.JobNr2Print
    Try
    ...
    Dim strQuery As String = _ListSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(_ListSetting.DbConnString2Open)
    Dim i As Integer = 0
    ...
    Try
      ...
      SetLLVariable(LL)
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), _
																		 ...
																		 CType(_ListSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel)
      ...
      If bShowBox Then
				LL.Core.LlPrintOptionsDialog(CType(_ListSetting.frmhwnd, IntPtr), String.Format("{1}: {2}{0}{3}", _
																																	 vbNewLine, _
      ...
      If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 m_path.GetSpSTempFolder, CType(_ListSetting.frmhwnd, IntPtr))
    ...
    Try
      ...
      SetExportSetting(iExportMode)
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), LlProject.List, LlProject.Card), _
																	_ClsLLFunc.LLDocName, LlPrintMode.Export, LlBoxType.StandardAbort, CType(_ListSetting.frmhwnd, IntPtr), _
      ...
      If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 ...
																 CType(_ListSetting.frmhwnd, IntPtr))
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me._ListSetting.DbConnString2Open, _ClsLLFunc, _ListSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me._ListSetting.USSignFileName)

    LL.Variables.Add("SortBez", _ListSetting.ListSortBez)
    LL.Variables.Add("FilterBez", _ListSetting.ListFilterBez(0))
    LL.Variables.Add("FilterBez2", _ListSetting.ListFilterBez(1))
    LL.Variables.Add("FilterBez3", _ListSetting.ListFilterBez(2))
    LL.Variables.Add("FilterBez4", _ListSetting.ListFilterBez(3))

    LL.Variables.Add("Dokbez", _ClsLLFunc.ListBez)

    LL.Variables.Add("Filter_Month_1", _ListSetting.Filter_VonMonth_1 & _
                  IIf(_ListSetting.Filter_BisMonth_1 <> "", " - ", "").ToString & _ListSetting.Filter_BisMonth_1)
    LL.Variables.Add("Filter_Year_1", _ListSetting.Filter_VonYear_1)

    LL.Variables.Add("Filter_Month_2", _ListSetting.Filter_VonMonth_2 & _
                  IIf(_ListSetting.Filter_BisMonth_2 <> "", " - ", "").ToString & _ListSetting.Filter_BisMonth_2)
    LL.Variables.Add("Filter_Year_2", _ListSetting.Filter_VonYear_2)
  ...
  Public Sub New(ByVal _Setting As ClsLLKDUmsatzSearchPrintSetting)

    Me._ListSetting = _Setting
    Me.strConnString = Me._ListSetting.DbConnString2Open
