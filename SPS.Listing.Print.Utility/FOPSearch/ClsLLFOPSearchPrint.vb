...
Public Class ClsLLFOPSearchPrint
  ...
  Dim FOPListPrintSetting As New ClsLLFOPSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = FOPListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", FOPListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.FOPListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      ...
      'If Me.FOPListPrintSetting.IsJobAsListing Then
      rFoundedrec = MainUtilities.OpenDb4PrintListing(strConnString, Me.FOPListPrintSetting.SQL2Open)

      'Else
      '  rFoundedrec = MainUtilities.OpenDb4PrintListing(Me.FOPListPrintSetting.SQL2Open, Me.FOPListPrintSetting, _
      '                                                                             Me.FOPListPrintSetting.OPNr2Print)
      'End If
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
		...
		Dim strJobNr As String = Me.FOPListPrintSetting.JobNr2Print
    Try
    ...
    Dim strQuery As String = FOPListPrintSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(strConnString)
    Dim i As Integer = 0
    ...
    Try
      ...
      'Else
      '  rFoundedrec = Utilities.OpenVakDb4PrintDoc(VakListPrintSetting.SQL2Open, Me.VakListPrintSetting, _
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.FOPListPrintSetting.DbConnString2Open, _ClsLLFunc, FOPListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me.FOPListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", FOPListPrintSetting.ListSortBez)
    LL.Variables.Add("FilterBez", FOPListPrintSetting.ListFilterBez(0))
    LL.Variables.Add("FilterBez2", FOPListPrintSetting.ListFilterBez(1))
    LL.Variables.Add("FilterBez3", FOPListPrintSetting.ListFilterBez(2))
    LL.Variables.Add("FilterBez4", FOPListPrintSetting.ListFilterBez(3))
  ...
  Public Sub New(ByVal _Setting As ClsLLFOPSearchPrintSetting)
    ...
    Me.FOPListPrintSetting = _Setting
