...
Public Class ClsLLZESearchPrint
	...
	Private ZEListPrintSetting As New ClsLLZESearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = ZEListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", ZEListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.ZEListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      ...
      rFoundedrec = MainUtilities.OpenDb4PrintListing(strConnString, Me.ZEListPrintSetting.SQL2Open)
      ...
      SetLLVariable(LL)
			...
			LL.Core.LlDefineLayout(CType(ZEListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel,
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
		...
		Dim strJobNr As String = Me.ZEListPrintSetting.JobNr2Print
    Try
    ...
    Dim strQuery As String = ZEListPrintSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(strConnString)
    Dim i As Integer = 0
    ...
    Try
      ...
      SetLLVariable(LL)
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper),
																		 ...
																		 CType(ZEListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel)
      ...
      If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName,
																 m_path.GetSpSTempFolder, CType(ZEListPrintSetting.frmhwnd, IntPtr))
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.ZEListPrintSetting.DbConnString2Open, _ClsLLFunc, ZEListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me.ZEListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", ZEListPrintSetting.ListSortBez)
    LL.Variables.Add("FilterBez", ZEListPrintSetting.ListFilterBez(0))
    LL.Variables.Add("FilterBez2", ZEListPrintSetting.ListFilterBez(1))
    LL.Variables.Add("FilterBez3", ZEListPrintSetting.ListFilterBez(2))
    LL.Variables.Add("FilterBez4", ZEListPrintSetting.ListFilterBez(3))

    LL.Variables.Add("Dokbez", _ClsLLFunc.ListBez)
    LL.Variables.Add("cTotalPayedZE", ZEListPrintSetting.TotalOpenBetrag4Date)
		LL.Variables.Add("CalculateVerfalltageWithCreatedOn", ZEListPrintSetting.CalculateVerfallTagWithCreatedOn.GetValueOrDefault(False))
		LL.Variables.Add("ShouldDivideAmount", If(ZEListPrintSetting.ShouldDivideAmount.GetValueOrDefault(False), 1, 0))
  ...
  Public Sub New(ByVal _Setting As ClsLLZESearchPrintSetting)
    ...
    Me.ZEListPrintSetting = _Setting
