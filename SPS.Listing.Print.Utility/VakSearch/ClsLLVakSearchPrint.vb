...
Public Class ClsLLVakSearchPrint
  ...
  Private m_md As New Mandant
	Private VakListPrintSetting As New ClsLLVakSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = VakListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", VakListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.VakListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      ...
      If Me.VakListPrintSetting.IsJobAsListing Then
        rFoundedrec = MainUtilities.OpenDb4PrintListing(strConnString, Me.VakListPrintSetting.SQL2Open)

      Else
        rFoundedrec = MainUtilities.OpenVakDb4PrintDoc(strConnString, Me.VakListPrintSetting.SQL2Open, Me.VakListPrintSetting, _
                                                                                   Me.VakListPrintSetting.VakNr2Print)
      End If
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
		...
		Dim strJobNr As String = Me.VakListPrintSetting.JobNr2Print
    Try
    ...
    Dim strQuery As String = VakListPrintSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(strConnString)
    Dim i As Integer = 0
    ...
    Try
      ...
      Else
        rFoundedrec = Utilities.OpenVakDb4PrintDoc(strConnString, VakListPrintSetting.SQL2Open, Me.VakListPrintSetting, _
                                                                         Me.VakListPrintSetting.VakNr2Print)
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.VakListPrintSetting.DbConnString2Open, _ClsLLFunc, 0)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me.VakListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", VakListPrintSetting.ListSortBez)
    LL.Variables.Add("FilterBez", VakListPrintSetting.ListFilterBez(0))
    LL.Variables.Add("FilterBez2", VakListPrintSetting.ListFilterBez(1))
    LL.Variables.Add("FilterBez3", VakListPrintSetting.ListFilterBez(2))
    LL.Variables.Add("FilterBez4", VakListPrintSetting.ListFilterBez(3))

    If Not Me.VakListPrintSetting.IsJobAsListing Then
      LL.Variables.Add("JobProz_0", String.Empty)
      LL.Variables.Add("JobProz_1", String.Empty)

      LL.Variables.Add("Anstellung_0", String.Empty)
      LL.Variables.Add("Anstellung_1", String.Empty)
      LL.Variables.Add("Anstellung_2", String.Empty)
      LL.Variables.Add("Anstellung_3", String.Empty)
      LL.Variables.Add("Anstellung_4", String.Empty)
      LL.Variables.Add("Anstellung_5", String.Empty)

      LL.Variables.Add("Alter_0", String.Empty)
      LL.Variables.Add("Alter_1", String.Empty)

      LL.Variables.Add("SprachBez_0", String.Empty)
      LL.Variables.Add("SprachBez_1", String.Empty)
      LL.Variables.Add("SprachBez_2", String.Empty)
      LL.Variables.Add("SprachBez_3", String.Empty)
      LL.Variables.Add("SprachNiveauBez_0", String.Empty)
      LL.Variables.Add("SprachNiveauBez_1", String.Empty)
      LL.Variables.Add("SprachNiveauBez_2", String.Empty)
      LL.Variables.Add("SprachNiveauBez_3", String.Empty)

      LL.Variables.Add("BerufGruppeBez_0", String.Empty)
      LL.Variables.Add("BerufGruppeBez_1", String.Empty)
      LL.Variables.Add("BerufGruppeBez_2", String.Empty)
      LL.Variables.Add("BerufGruppeBez_3", String.Empty)
      LL.Variables.Add("FachGruppeBez_0", String.Empty)
      LL.Variables.Add("FachGruppeBez_1", String.Empty)
      LL.Variables.Add("FachGruppeBez_2", String.Empty)
      LL.Variables.Add("FachGruppeBez_3", String.Empty)

      Try

        ' Jobprozent
        aValue = Me.VakListPrintSetting.ExtraVakFieldData(0).Split("#").ToList
        For i As Integer = 0 To aValue.Count - 1
          LL.Variables.Add(String.Format("JobProz_{0}", i), aValue(i))
        Next
        ' Anstellungsart
        aValue = Me.VakListPrintSetting.ExtraVakFieldData(1).Split("#").ToList
        For i As Integer = 0 To aValue.Count - 1
          Select Case aValue(i)
            Case 1
              aValue(i) = TranslateMyText("Festanstellung")
            Case 2
              aValue(i) = TranslateMyText("Freelancer")
            Case 3
              aValue(i) = TranslateMyText("Praktikum")
            Case 4
              aValue(i) = TranslateMyText("Temporär")
            Case 5
              aValue(i) = TranslateMyText("Lehrstelle")
            Case 6
              aValue(i) = TranslateMyText("Nebenerwerb")

          End Select
          LL.Variables.Add(String.Format("Anstellung_{0}", i), aValue(i))
        Next
        ' Alter
        aValue = Me.VakListPrintSetting.ExtraVakFieldData(2).Split("#").ToList
        For i As Integer = 0 To aValue.Count - 1
          Select Case aValue(i)
            Case 1
              aValue(i) = TranslateMyText("Bis 24 Jahr")
            Case 2
              aValue(i) = TranslateMyText("25-34 Jahre")
            Case 3
              aValue(i) = TranslateMyText("35-44 Jahre")
            Case 4
              aValue(i) = TranslateMyText("45-65 Jahre")

          End Select
          LL.Variables.Add(String.Format("Alter_{0}", i), aValue(i))
        Next
        ' Sprachbez
        aValue = Me.VakListPrintSetting.ExtraVakFieldData(3).Split("#").ToList
        For i As Integer = 0 To aValue.Count - 1
          LL.Variables.Add(String.Format("SprachBez_{0}", i), aValue(i))
        Next
				' SprachNiveauBez
				If Not VakListPrintSetting.ExtraVakFieldData(4) Is Nothing Then
					aValue = Me.VakListPrintSetting.ExtraVakFieldData(4).Split("#").ToList
					For i As Integer = 0 To aValue.Count - 1
						LL.Variables.Add(String.Format("SprachNiveauBez_{0}", i), aValue(i))
					Next
				End If

				' BerufgruppeBez
				If Not VakListPrintSetting.ExtraVakFieldData(5) Is Nothing Then
					aValue = Me.VakListPrintSetting.ExtraVakFieldData(5).Split("#").ToList
					For i As Integer = 0 To aValue.Count - 1
						LL.Variables.Add(String.Format("BerufGruppeBez_{0}", i), aValue(i))
					Next
					' FachgruppeBez
					aValue = Me.VakListPrintSetting.ExtraVakFieldData(5).Split("#").ToList
					For i As Integer = 0 To aValue.Count - 1
						LL.Variables.Add(String.Format("FachGruppeBez_{0}", i), aValue(i))
					Next
				End If
  ...
  Public Sub New(ByVal _Setting As ClsLLVakSearchPrintSetting)
    ...
    Me.VakListPrintSetting = _Setting
