...
Public Class ClsLLCallHistoryPrint
  ...
  Private _CHListPrintSetting As New ClsLLCallHistoryPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = _CHListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", _CHListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me._CHListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
	...
	Sub ShowInDesign()
		...
		Try
			Dim rFoundedrec As SqlDataReader = MainUtilities.OpenDb4PrintListing(strConnString, Me._CHListPrintSetting.SQL2Open)
			...
			LL.Core.LlDefineLayout(CType(_CHListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel, _
	...
	Function ShowInPrint(ByRef bShowBox As Boolean) As String
		...
		Dim strJobNr As String = Me._CHListPrintSetting.JobNr2Print

		Dim strQuery As String = _CHListPrintSetting.SQL2Open
		Dim Conn As SqlConnection = New SqlConnection(strConnString)
		Dim i As Integer = 0
		...
		Try
			Dim rFoundedrec As SqlDataReader = Utilities.OpenDb4PrintListing(strConnString, _CHListPrintSetting.SQL2Open)
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), _
																		 ...
																		 CType(_CHListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel)
			...
			If bShowBox Then
				LL.Core.LlPrintOptionsDialog(CType(_CHListPrintSetting.frmhwnd, IntPtr), String.Format("{1}: {2}{0}{3}", _
																																	 vbNewLine, _
			...
			If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 m_path.GetSpSTempFolder, CType(_CHListPrintSetting.frmhwnd, IntPtr))
	...
	Function ExportLLDoc(ByVal LL As ListLabel, ByVal strJobNr As String, ByVal iExportMode As Short, _
		...
		Try
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), LlProject.List, LlProject.Card), _
																	_ClsLLFunc.LLDocName, LlPrintMode.Export, LlBoxType.StandardAbort, CType(_CHListPrintSetting.frmhwnd, IntPtr), _
			...
			If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 ...
																 CType(_CHListPrintSetting.frmhwnd, IntPtr))
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me._CHListPrintSetting.DbConnString2Open, _ClsLLFunc, _CHListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me._CHListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", _CHListPrintSetting.ListSortBez)
    LL.Variables.Add("FilterBez", _CHListPrintSetting.ListFilterBez(0))
    LL.Variables.Add("FilterBez2", _CHListPrintSetting.ListFilterBez(1))
    LL.Variables.Add("FilterBez3", _CHListPrintSetting.ListFilterBez(2))
    LL.Variables.Add("FilterBez4", _CHListPrintSetting.ListFilterBez(3))
  ...
  Public Sub New(ByVal _Setting As ClsLLCallHistoryPrintSetting)
    ...
    Me._CHListPrintSetting = _Setting
