...
Public Class ClsLLZGSearchPrint
	...
	Private ZGListPrintSetting As New ClsLLZGSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = ZGListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", ZGListPrintSetting.JobNr2Print)
      Dim rDocrec As SqlDataReader = cmd.ExecuteReader
      rDocrec.Read()
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.ZGListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      ...
      rFoundedrec = MainUtilities.OpenDb4PrintListing(strConnString, Me.ZGListPrintSetting.SQL2Open)
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
		...
		Dim strJobNr As String = Me.ZGListPrintSetting.JobNr2Print
    Try
    ...
    Dim strQuery As String = ZGListPrintSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(strConnString)
    Dim i As Integer = 0
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.ZGListPrintSetting.DbConnString2Open, _ClsLLFunc, ZGListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me.ZGListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", ZGListPrintSetting.ListSortBez)
    LL.Variables.Add("FilterBez", ZGListPrintSetting.ListFilterBez(0))
    LL.Variables.Add("FilterBez2", ZGListPrintSetting.ListFilterBez(1))
    LL.Variables.Add("FilterBez3", ZGListPrintSetting.ListFilterBez(2))
    LL.Variables.Add("FilterBez4", ZGListPrintSetting.ListFilterBez(3))

    LL.Variables.Add("Dokbez", _ClsLLFunc.ListBez)
    LL.Variables.Add("IsSignPositiv", ZGListPrintSetting.ShowBetragAsPositiv)
  ...
  Public Sub New(ByVal _Setting As ClsLLZGSearchPrintSetting)
    ...
    Me.ZGListPrintSetting = _Setting
