...
Public Class ClsLLKDSearchPrint
  ...
  Dim KDListPrintSetting As New ClsLLKDSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Try
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.KDListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
	...
	Sub ShowInDesign()
		...
		Try
			Dim rFoundedrec As SqlDataReader = OpenDb4PrintListing(strConnString, KDListPrintSetting.SQL2Open)
  ...
  Sub SetLLVariable()
    ...
    LL.Variables.Add("SortBez", KDListPrintSetting.ListSortBez)
    LL.Variables.Add("FilterBez", KDListPrintSetting.ListFilterBez(0))
    LL.Variables.Add("FilterBez2", KDListPrintSetting.ListFilterBez(1))
    LL.Variables.Add("FilterBez3", KDListPrintSetting.ListFilterBez(2))
    LL.Variables.Add("FilterBez4", KDListPrintSetting.ListFilterBez(3))
