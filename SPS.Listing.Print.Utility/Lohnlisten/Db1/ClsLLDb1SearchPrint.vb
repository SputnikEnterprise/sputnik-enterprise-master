...
Public Class ClsLLDb1SearchPrint
  ...
  Private m_md As New Mandant
	Private Db1ListPrintSetting As New ClsLLDb1SearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = Db1ListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", Db1ListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.Db1ListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      Dim rFoundedrec As SqlDataReader = MainUtilities.OpenDb4PrintListing(strConnString, Me.Db1ListPrintSetting.SQL2Open)
      ...
      SetLLVariable(LL)
			...
			LL.Core.LlDefineLayout(CType(Db1ListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel, _
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strJobNr As String = Me.Db1ListPrintSetting.JobNr2Print

    Dim strQuery As String = Db1ListPrintSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(strConnString)
    Dim i As Integer = 0
    ...
    Try
      Dim rFoundedrec As SqlDataReader = Utilities.OpenDb4PrintListing(strConnString, Db1ListPrintSetting.SQL2Open)
      ...
      SetLLVariable(LL)
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), _
																		 ...
																		 CType(Db1ListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel)
      ...
      If bShowBox Then
				LL.Core.LlPrintOptionsDialog(CType(Db1ListPrintSetting.frmhwnd, IntPtr), String.Format("{1}: {2}{0}{3}", _
																																	 vbNewLine, _
      ...
      If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 m_path.GetSpSTempFolder, CType(Db1ListPrintSetting.frmhwnd, IntPtr))
    ...
    Try
      ...
      SetExportSetting(iExportMode)
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), LlProject.List, LlProject.Card), _
																	_ClsLLFunc.LLDocName, LlPrintMode.Export, LlBoxType.StandardAbort, CType(Db1ListPrintSetting.frmhwnd, IntPtr), _
      ...
      If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 ...
																 CType(Db1ListPrintSetting.frmhwnd, IntPtr))
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.Db1ListPrintSetting.DbConnString2Open, _ClsLLFunc, Db1ListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me.Db1ListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", Db1ListPrintSetting.ListSortBez)
		LL.Variables.Add("FilterBez", Db1ListPrintSetting.ListFilterBez(0))
		LL.Variables.Add("FilterBez2", "")
		LL.Variables.Add("FilterBez3", "")
		LL.Variables.Add("FilterBez4", "")

    LL.Fields.Add("XMarge", Db1ListPrintSetting.XMarge())

    LL.Fields.Add("_dTotalTemp", Db1ListPrintSetting._dTotalTemp)
    LL.Fields.Add("_dTotalInd", Db1ListPrintSetting._dTotalInd)
    LL.Fields.Add("_dTotalFest", Db1ListPrintSetting._dTotalFest)

    If Db1ListPrintSetting.bAsGrouped Then
      LL.Fields.Add("Kst3_1", "0_0")
      LL.Variables.Add("Kst3_1", "0_0")
      LL.Fields.Add("Kst3Bez", "0_0")
      LL.Variables.Add("Kst3Bez", "0_0")
    End If


		LL.Fields.Add("Filter_Month_1", Db1ListPrintSetting.Filter_Month_1)
		LL.Variables.Add("FltJahr", Db1ListPrintSetting.FltJahr)

		LL.Variables.Add("VonMonat", Db1ListPrintSetting.VonMonat)
		LL.Variables.Add("BisMonat", Db1ListPrintSetting.BisMonat)

		LL.Variables.Add("XMarge_2", Db1ListPrintSetting.XMarge_2)
  ...
  Public Sub New(ByVal _Setting As ClsLLDb1SearchPrintSetting)
    ...
    Me.Db1ListPrintSetting = _Setting
