...
Public Class ClsLLLOAGSearchPrint
  ...
  Private m_md As New Mandant
	Private LOAGListPrintSetting As New ClsLLLOAGSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = LOAGListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", LOAGListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.LOAGListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      Dim rFoundedrec As SqlDataReader = MainUtilities.OpenDb4PrintListing(strConnString, Me.LOAGListPrintSetting.SQL2Open)
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strJobNr As String = Me.LOAGListPrintSetting.JobNr2Print

    Dim strQuery As String = LOAGListPrintSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(strConnString)
    Dim i As Integer = 0
    ...
    Try
      Dim rFoundedrec As SqlDataReader = Utilities.OpenDb4PrintListing(strConnString, LOAGListPrintSetting.SQL2Open)
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.LOAGListPrintSetting.DbConnString2Open, _ClsLLFunc, LOAGListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me.LOAGListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", LOAGListPrintSetting.ListSortBez)
    LL.Variables.Add("FilterBez", LOAGListPrintSetting.ListFilterBez(0))
		LL.Variables.Add("FilterBez2", If(LOAGListPrintSetting.ListFilterBez.Count > 1, LOAGListPrintSetting.ListFilterBez(1), String.Empty))
		LL.Variables.Add("FilterBez3", If(LOAGListPrintSetting.ListFilterBez.Count > 2, LOAGListPrintSetting.ListFilterBez(2), String.Empty))
		LL.Variables.Add("FilterBez4", If(LOAGListPrintSetting.ListFilterBez.Count > 3, LOAGListPrintSetting.ListFilterBez(3), String.Empty))


    LL.Variables.Add("ListBez2Print", LOAGListPrintSetting.ListBez2Print)
  ...
  Public Sub New(ByVal _Setting As ClsLLLOAGSearchPrintSetting)
    ...
    Me.LOAGListPrintSetting = _Setting
