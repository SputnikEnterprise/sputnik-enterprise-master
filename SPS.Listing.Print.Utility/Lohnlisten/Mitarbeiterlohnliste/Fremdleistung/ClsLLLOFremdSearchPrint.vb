...
Public Class ClsLLLOFremdSearchPrint
  ...
  Dim LOFremdListPrintSetting As New ClsLLLOFremdSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = LOFremdListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", LOFremdListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.LOFremdListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      Dim rFoundedrec As SqlDataReader = MainUtilities.OpenDb4PrintListing(strConnString, Me.LOFremdListPrintSetting.SQL2Open)
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strJobNr As String = Me.LOFremdListPrintSetting.JobNr2Print

    Dim strQuery As String = LOFremdListPrintSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(strConnString)
    Dim i As Integer = 0
    ...
    Try
      Dim rFoundedrec As SqlDataReader = Utilities.OpenDb4PrintListing(strConnString, LOFremdListPrintSetting.SQL2Open)
      ...
      SetLLVariable(LL)
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), _
																		 ...
																		 CType(LOFremdListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel)
      ...
      If bShowBox Then
				LL.Core.LlPrintOptionsDialog(CType(LOFremdListPrintSetting.frmhwnd, IntPtr), String.Format("{1}: {2}{0}{3}", _
																																	 vbNewLine, _
      ...
      If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 m_path.GetSpSTempFolder, CType(LOFremdListPrintSetting.frmhwnd, IntPtr))
		...
		Catch LlException As Exception
			m_Logger.LogWarning(String.Format("LlException.{0}: {1}", strMethodeName, LlException.Message))
    ...
    Try
      ...
      SetExportSetting(iExportMode)
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), LlProject.List, LlProject.Card), _
																	_ClsLLFunc.LLDocName, LlPrintMode.Export, LlBoxType.StandardAbort, CType(LOFremdListPrintSetting.frmhwnd, IntPtr), _
      ...
      If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 ...
																 CType(LOFremdListPrintSetting.frmhwnd, IntPtr))
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.LOFremdListPrintSetting.DbConnString2Open, _ClsLLFunc, LOFremdListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me.LOFremdListPrintSetting.USSignFileName)

		LL.Variables.Add("SortBez", LOFremdListPrintSetting.ListSortBez)
		LL.Variables.Add("FilterBez", LOFremdListPrintSetting.ListFilterBez(0))
		LL.Variables.Add("FilterBez2", If(LOFremdListPrintSetting.ListFilterBez.Count > 1, LOFremdListPrintSetting.ListFilterBez(1), String.Empty))
		LL.Variables.Add("FilterBez3", If(LOFremdListPrintSetting.ListFilterBez.Count > 2, LOFremdListPrintSetting.ListFilterBez(2), String.Empty))
		LL.Variables.Add("FilterBez4", If(LOFremdListPrintSetting.ListFilterBez.Count > 3, LOFremdListPrintSetting.ListFilterBez(3), String.Empty))

		LL.Variables.Add("ListBez2Print", LOFremdListPrintSetting.ListBez2Print)
  ...
  Public Sub New(ByVal _Setting As ClsLLLOFremdSearchPrintSetting)
    ...
    Me.LOFremdListPrintSetting = _Setting
