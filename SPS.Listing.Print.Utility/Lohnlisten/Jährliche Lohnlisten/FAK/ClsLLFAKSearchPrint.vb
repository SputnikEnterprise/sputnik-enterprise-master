...
Public Class ClsLLFAKSearchPrint
  ...
  Dim FAKListPrintSetting As New ClsLLFAKSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = FAKListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", FAKListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.FAKListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
	...
	Sub ShowInDesign()
		...
		Try
			Dim rFoundedrec As SqlDataReader = MainUtilities.OpenDb4PrintListing(strConnString, Me.FAKListPrintSetting.SQL2Open)
			...
			LL.Core.LlDefineLayout(CType(FAKListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel, _
	...
	Function ShowInPrint(ByRef bShowBox As Boolean) As String
		...
		'Dim LL As New ListLabel
		Dim strJobNr As String = Me.FAKListPrintSetting.JobNr2Print
		Try
		...
		Dim strQuery As String = FAKListPrintSetting.SQL2Open
		Dim Conn As SqlConnection = New SqlConnection(strConnString)
		Dim i As Integer = 0
		...
		Try
			Dim rFoundedrec As SqlDataReader = Utilities.OpenDb4PrintListing(strConnString, FAKListPrintSetting.SQL2Open)
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), _
																		 ...
																		 CType(FAKListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel)
			...
			If bShowBox Then
				LL.Core.LlPrintOptionsDialog(CType(FAKListPrintSetting.frmhwnd, IntPtr), String.Format("{1}: {2}{0}{3}", _
																																	 vbNewLine, _
			...
			If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 m_path.GetSpSTempFolder, CType(FAKListPrintSetting.frmhwnd, IntPtr))
	...
	Function ExportLLDoc(ByVal LL As ListLabel, ByVal strJobNr As String, ByVal iExportMode As Short, _
		...
		Try
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), LlProject.List, LlProject.Card), _
																	_ClsLLFunc.LLDocName, LlPrintMode.Export, LlBoxType.StandardAbort, CType(FAKListPrintSetting.frmhwnd, IntPtr), _
			...
			If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 ...
																 CType(FAKListPrintSetting.frmhwnd, IntPtr))
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.FAKListPrintSetting.DbConnString2Open, _ClsLLFunc, FAKListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me.FAKListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", FAKListPrintSetting.ListSortBez)
    LL.Variables.Add("FilterBez", FAKListPrintSetting.ListFilterBez(0))
    LL.Variables.Add("FilterBez2", FAKListPrintSetting.ListFilterBez(1))
    LL.Variables.Add("FilterBez3", FAKListPrintSetting.ListFilterBez(2))
    LL.Variables.Add("FilterBez4", FAKListPrintSetting.ListFilterBez(3))

    LL.Variables.Add("ListBez2Print", FAKListPrintSetting.ListBez2Print)
  ...
  Public Sub New(ByVal _Setting As ClsLLFAKSearchPrintSetting)
    ...
    Me.FAKListPrintSetting = _Setting
