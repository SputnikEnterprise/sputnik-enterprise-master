...
Namespace JLohnRekapSearchListing

	Public Class ClsPrintJLohnRekapSearchList

		Private _ClsSetting As New ClsLLJLohnRekapSearchPrintSetting

		Public Property PrintData As ClsLLJLohnRekapSearchPrintSetting


		Function PrintJLohnRekapSearchList() As String
			Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
			Dim strResult As String = String.Empty

			'Dim _clsSetting As ClsLLJLohnRekapSearchPrintSetting = _clsSetting

			Dim _clsPrint As New ClsLLJLohnRekapSearchPrint(_ClsSetting)
