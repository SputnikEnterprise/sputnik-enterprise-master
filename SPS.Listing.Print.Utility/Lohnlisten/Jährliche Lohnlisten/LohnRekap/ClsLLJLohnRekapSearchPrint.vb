...
Public Class ClsLLJLohnRekapSearchPrint
	...
	Private JLohnRekapSetting As New ClsLLJLohnRekapSearchPrintSetting
	...
	Public Sub New(ByVal _Setting As ClsLLJLohnRekapSearchPrintSetting)
