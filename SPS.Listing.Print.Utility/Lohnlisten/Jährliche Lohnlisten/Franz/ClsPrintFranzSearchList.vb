...
Namespace FranzSearchListing

	Public Class ClsPrintFranzSearchList

		Private _ClsSetting As New ClsLLFranzSearchPrintSetting

		Public Property PrintData As ClsLLFranzSearchPrintSetting


		Function PrintFranzSearchList() As String
			Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
			Dim strResult As String = String.Empty

			Dim _clsPrint As New ClsLLFranzSearchPrint(_ClsSetting)
