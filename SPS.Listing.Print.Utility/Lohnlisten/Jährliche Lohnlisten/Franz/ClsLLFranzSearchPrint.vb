...
Public Class ClsLLFranzSearchPrint
  ...
  Private m_md As New Mandant
	Private _FranzListPrintSetting As New ClsLLFranzSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = _FranzListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", _FranzListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me._FranzListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
	...
	Sub ShowInDesign()
		...
		Try
			Dim rFoundedrec As SqlDataReader = MainUtilities.OpenDb4PrintListing(strConnString, Me._FranzListPrintSetting.SQL2Open)
			...
			LL.Core.LlDefineLayout(CType(_FranzListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel, _
	...
	Function ShowInPrint(ByRef bShowBox As Boolean) As String
		...
		Dim strJobNr As String = Me._FranzListPrintSetting.JobNr2Print
		Try
		...
		Dim strQuery As String = _FranzListPrintSetting.SQL2Open
		Dim Conn As SqlConnection = New SqlConnection(strConnString)
		Dim i As Integer = 0
		...
		Try
			Dim rFoundedrec As SqlDataReader = Utilities.OpenDb4PrintListing(strConnString, _FranzListPrintSetting.SQL2Open)
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), _
																		 ...
																		 CType(_FranzListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel)
			...
			If bShowBox Then
				LL.Core.LlPrintOptionsDialog(CType(_FranzListPrintSetting.frmhwnd, IntPtr), String.Format("{1}: {2}{0}{3}", _
																																	 vbNewLine, _
			...
			If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 m_path.GetSpSTempFolder, CType(_FranzListPrintSetting.frmhwnd, IntPtr))
	...
	Function ExportLLDoc(ByVal LL As ListLabel, ByVal strJobNr As String, ByVal iExportMode As Short, _
		...
		Try
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), LlProject.List, LlProject.Card), _
																	_ClsLLFunc.LLDocName, LlPrintMode.Export, LlBoxType.StandardAbort, CType(_FranzListPrintSetting.frmhwnd, IntPtr), _
			...
			If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, m_path.GetSpSTempFolder, CType(_FranzListPrintSetting.frmhwnd, IntPtr))
				LL.Core.LlPreviewDeleteFiles(_ClsLLFunc.LLDocName, m_path.GetSpSTempFolder)
				Return False
			End If
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me._FranzListPrintSetting.DbConnString2Open, _ClsLLFunc, _FranzListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
    ...
    LL.Variables.Add("USSignFilename", Me._FranzListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", _FranzListPrintSetting.ListSortBez)
		LL.Variables.Add("FilterBez", _FranzListPrintSetting.ListFilterBez(0))
		LL.Variables.Add("FilterBez2", If(_FranzListPrintSetting.ListFilterBez.Count > 1, _FranzListPrintSetting.ListFilterBez(1), String.Empty))
		LL.Variables.Add("FilterBez3", If(_FranzListPrintSetting.ListFilterBez.Count > 2, _FranzListPrintSetting.ListFilterBez(2), String.Empty))
		LL.Variables.Add("FilterBez4", If(_FranzListPrintSetting.ListFilterBez.Count > 3, _FranzListPrintSetting.ListFilterBez(3), String.Empty))

    LL.Variables.Add("ListBez2Print", _FranzListPrintSetting.ListBez2Print)
  ...
  Public Sub New(ByVal _Setting As ClsLLFranzSearchPrintSetting)

    Me._FranzListPrintSetting = _Setting
