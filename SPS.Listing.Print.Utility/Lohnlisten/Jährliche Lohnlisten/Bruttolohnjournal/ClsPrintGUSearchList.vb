...
Namespace GUSearchListing

	Public Class ClsPrintGUSearchList

		Private _ClsSetting As New ClsLLGUSearchPrintSetting

		Public Property PrintData As ClsLLGUSearchPrintSetting
...
#End Region
		...
		Function PrintGUListing() As String
			Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
			Dim strResult As String = String.Empty

			Me.PrintData.USSignFileName = GetUSSign(m_InitialData.MDData.MDDbConn)
			Dim _clsMAPrint As New ClsLLGUSearchPrint(PrintData)
			If PrintData.ShowAsDesign Then _clsMAPrint.ShowInDesign() Else _clsMAPrint.ShowInPrint(True)
			_clsMAPrint.Dispose()
