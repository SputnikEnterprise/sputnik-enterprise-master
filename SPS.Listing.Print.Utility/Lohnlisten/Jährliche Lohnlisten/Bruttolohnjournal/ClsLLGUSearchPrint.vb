...
Public Class ClsLLGUSearchPrint
...
#End Region
	...
	Private PrintSetting As New ClsLLGUSearchPrintSetting
	...
	Sub ShowInDesign()
		...
		Try
			...
			LL.Core.LlDefineLayout(CType(PrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel, _
	...
	Sub SetLLVariable()
		...
		LL.Variables.Add("ShowFeier", PrintSetting.ShowG500)
		LL.Variables.Add("ShowFerien", PrintSetting.ShowG600)
		LL.Variables.Add("Show13Lohn", PrintSetting.ShowG700)
		LL.Variables.Add("ShowDarlehen", PrintSetting.ShowGDar)
		LL.Variables.Add("ShowGleitstunden", PrintSetting.ShowGGTime)
		LL.Variables.Add("ShowFeierVJ", PrintSetting.ShowG529)
		LL.Variables.Add("ShowFerienVJ", PrintSetting.ShowG629)
		LL.Variables.Add("Show13LohnVJ", PrintSetting.ShowG729)
	...
	Public Sub New(ByVal _Setting As ClsLLGUSearchPrintSetting)
