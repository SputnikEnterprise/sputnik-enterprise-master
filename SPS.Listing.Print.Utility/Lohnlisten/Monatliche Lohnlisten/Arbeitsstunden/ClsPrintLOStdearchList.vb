...
Namespace LOStdSearchListing

	Public Class ClsPrintLOStdSearchList

		Private _ClsSetting As New ClsLLLOStdSearchPrintSetting

		Public Property PrintData As ClsLLLOStdSearchPrintSetting


		Function PrintLOStdSearchList() As String
			Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
			Dim strResult As String = String.Empty

			Dim _clsLOStdPrint As New ClsLLLOStdSearchPrint(_ClsSetting)
			If _ClsSetting.ShowAsDesign Then
				_clsLOStdPrint.ShowInDesign()
			Else
				strResult = _clsLOStdPrint.ShowInPrint(True)
			End If
			_clsLOStdPrint.Dispose()
