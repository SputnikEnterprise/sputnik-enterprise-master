...
Public Class ClsLLLMSearchPrint
...
#End Region
  ...
  Private m_md As New Mandant
	Dim MAListPrintSetting As New ClsLLLMSearchPrintSetting
	...
	Function BuildPrintJob() As Boolean
		...
		Try
			...
			If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
				_ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.MAListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
	...
	Sub ShowInDesign()
		...
		Try
			Dim rFoundedrec As SqlDataReader = MainUtilities.OpenDb4PrintLMListing(strConnString, Me.MAListPrintSetting.SelectedLMNr)
	...
	Sub SetLLVariable()
		...
		LL.Variables.Add("SortBez", MAListPrintSetting.ListSortBez)
		LL.Variables.Add("FilterBez", MAListPrintSetting.ListFilterBez(0))
		LL.Variables.Add("FilterBez2", If(MAListPrintSetting.ListFilterBez.Count > 1, MAListPrintSetting.ListFilterBez(1), String.Empty))
		LL.Variables.Add("FilterBez3", If(MAListPrintSetting.ListFilterBez.Count > 2, MAListPrintSetting.ListFilterBez(2), String.Empty))
		LL.Variables.Add("FilterBez4", If(MAListPrintSetting.ListFilterBez.Count > 3, MAListPrintSetting.ListFilterBez(3), String.Empty))
	...
	Public Sub New(ByVal _Setting As ClsLLLMSearchPrintSetting)
