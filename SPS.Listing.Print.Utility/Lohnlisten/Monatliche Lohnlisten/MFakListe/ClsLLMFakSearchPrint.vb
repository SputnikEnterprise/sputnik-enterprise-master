...
Public Class ClsLLMFakSearchPrint
...
#Region "private fields"
	...
	Private m_printSetting As New ClsLLMFakSetting
...
#Region "Constructor"
	...
	Public Sub New(ByVal _setting As SP.Infrastructure.Initialization.InitializeClass, ByVal _PrintSetting As ClsLLMFakSetting)

		m_printSetting = _PrintSetting
		m_InitializationData = _setting

		m_path = New ClsProgPath
		m_md = New Mandant

		Me.strConnString = Me.m_printSetting.DbConnString2Open
...
#End Region
	...
	Function BuildPrintJob() As Boolean
		...
		Try
			...
			If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
				_ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.m_printSetting.SelectedMDNr) & rDocrec("DocName").ToString
	...
	Sub ShowInDesign()
		...
		Try
			...
			rFoundedrec = MainUtilities.OpenDb4PrintListing(strConnString, Me.m_printSetting.SQL2Open)
	...
	Function ShowInPrint(ByRef bShowBox As Boolean) As String
		...
		Dim strQuery As String = m_printSetting.SQL2Open
		Dim Conn As SqlConnection = New SqlConnection(m_printSetting.DbConnString2Open)
		Dim i As Integer = 0
	...
	Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		_ClsLLFunc.USNachname = m_InitializationData.UserData.UserLName
		_ClsLLFunc.USVorname = m_InitializationData.UserData.UserFName
		ClsMainSetting.UserData = m_InitializationData.UserData
		ClsMainSetting.MDData = m_InitializationData.MDData

		MainUtilities.GetUSData(m_InitializationData.MDData.MDDbConn, _ClsLLFunc, m_InitializationData.MDData.MDNr)
		With _ClsLLFunc
	...
	Sub SetLLVariable(ByVal LL As ListLabel)
		...
		LL.Variables.Add("FilterBez2", If(m_printSetting.ListFilterBez.Count > 1, m_printSetting.ListFilterBez(1), String.Empty))
		LL.Variables.Add("FilterBez3", If(m_printSetting.ListFilterBez.Count > 2, m_printSetting.ListFilterBez(2), String.Empty))
		LL.Variables.Add("FilterBez4", If(m_printSetting.ListFilterBez.Count > 3, m_printSetting.ListFilterBez(3), String.Empty))
