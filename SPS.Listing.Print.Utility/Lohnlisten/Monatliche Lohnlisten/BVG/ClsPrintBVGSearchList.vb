...
Namespace BVGSearchListing

	Public Class ClsPrintBVGSearchList

		Private _ClsSetting As New ClsLLBVGSearchPrintSetting

		Public Property PrintData As ClsLLBVGSearchPrintSetting

		Function PrintBVGListing() As String
			Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
			Dim strResult As String = String.Empty

			Dim _clsMAPrint As New ClsLLBVGSearchPrint(_ClsSetting)
