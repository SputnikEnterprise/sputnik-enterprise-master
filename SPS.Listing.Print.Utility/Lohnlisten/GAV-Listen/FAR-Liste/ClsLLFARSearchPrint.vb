...
Public Class ClsLLFARSearchPrint
  ...
  Dim FARListPrintSetting As New ClsLLFARSearchPrintSetting
  ...
  Function BuildPrintJob() As Boolean
    ...
    Dim JobNr As String = FARListPrintSetting.JobNr2Print
    ...
    Try
      ...
      param = cmd.Parameters.AddWithValue("@JobNr", FARListPrintSetting.JobNr2Print)
      ...
      If Not String.IsNullOrEmpty(rDocrec("DocName").ToString) Then
        _ClsLLFunc.LLDocName = m_md.GetSelectedMDDocPath(Me.FARListPrintSetting.SelectedMDNr) & rDocrec("DocName").ToString
  ...
  Sub ShowInDesign()
    ...
    Try
      Dim rFoundedrec As SqlDataReader = MainUtilities.OpenDb4PrintListing(strConnString, Me.FARListPrintSetting.SQL2Open)
      ...
      SetLLVariable(LL)
			...
			LL.Core.LlDefineLayout(CType(FARListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel, _
  ...
  Function ShowInPrint(ByRef bShowBox As Boolean) As String
    ...
    Dim strJobNr As String = Me.FARListPrintSetting.JobNr2Print
    Try
    ...
    Dim strQuery As String = FARListPrintSetting.SQL2Open
    Dim Conn As SqlConnection = New SqlConnection(strConnString)
    Dim i As Integer = 0
    ...
    Try
      Dim rFoundedrec As SqlDataReader = Utilities.OpenDb4PrintListing(strConnString, FARListPrintSetting.SQL2Open)
      ...
      SetLLVariable(LL)
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), _
																		 ...
																		 CType(FARListPrintSetting.frmhwnd, IntPtr), _ClsLLFunc.LLDocLabel)
      ...
      If bShowBox Then
				LL.Core.LlPrintOptionsDialog(CType(FARListPrintSetting.frmhwnd, IntPtr), String.Format("{1}: {2}{0}{3}", _
																																	 vbNewLine, _
      ...
      If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 m_path.GetSpSTempFolder, CType(FARListPrintSetting.frmhwnd, IntPtr))
    ...
    Try
      ...
      SetExportSetting(iExportMode)
			...
			LL.Core.LlPrintWithBoxStart(If(_ClsLLFunc.LLDocName.ToUpper.EndsWith(".LST".ToUpper), LlProject.List, LlProject.Card), _
																	_ClsLLFunc.LLDocName, LlPrintMode.Export, LlBoxType.StandardAbort, CType(FARListPrintSetting.frmhwnd, IntPtr), _
      ...
      If TargetFormat = "PRV" Then
				LL.Core.LlPreviewDisplay(_ClsLLFunc.LLDocName, _
																 ...
																 CType(FARListPrintSetting.frmhwnd, IntPtr))
  ...
  Sub GetMDUSData4Print(ByVal LL As ListLabel)
		...
		MainUtilities.GetUSData(Me.FARListPrintSetting.DbConnString2Open, _ClsLLFunc, FARListPrintSetting.SelectedMDNr)
		With _ClsLLFunc
  ...
  Sub SetLLVariable(ByVal LL As ListLabel)
		Dim FORM_XML_MAIN_KEY As String = String.Format("MD_{0}", FARListPrintSetting.SelectedMDNr)
		Dim mdXMLFile As String = m_md.GetSelectedMDDataXMLFilename(FARListPrintSetting.SelectedMDNr, Now.Year)
    ...
    LL.Variables.Add("USSignFilename", Me.FARListPrintSetting.USSignFileName)

    LL.Variables.Add("SortBez", FARListPrintSetting.ListSortBez)
		LL.Variables.Add("FORResor", FARListPrintSetting.FORResor)

		LL.Variables.Add("FilterBez", FARListPrintSetting.ListFilterBez(0))
		LL.Variables.Add("FilterBez2", If(FARListPrintSetting.ListFilterBez.Count > 1, FARListPrintSetting.ListFilterBez(1), String.Empty))
		LL.Variables.Add("FilterBez3", If(FARListPrintSetting.ListFilterBez.Count > 2, FARListPrintSetting.ListFilterBez(2), String.Empty))
		LL.Variables.Add("FilterBez4", If(FARListPrintSetting.ListFilterBez.Count > 3, FARListPrintSetting.ListFilterBez(3), String.Empty))

    LL.Variables.Add("ListBez2Print", FARListPrintSetting.ListBez2Print)

		Dim iFARMitgliedNr As String = m_path.GetXMLNodeValue(mdXMLFile, String.Format("{0}/Sonstiges/FAR.-MitgliedNr", FORM_XML_MAIN_KEY))
		LL.Variables.Add("MitgliederNr", iFARMitgliedNr)
  ...
  Public Sub New(ByVal _Setting As ClsLLFARSearchPrintSetting)
    ...
    Me.FARListPrintSetting = _Setting
