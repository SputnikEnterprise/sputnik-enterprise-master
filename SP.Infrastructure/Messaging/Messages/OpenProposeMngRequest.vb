...
Namespace Messaging.Messages
	...
	''' <summary>
	''' Request to open an propose management form.
	''' </summary>
	Public Class OpenProposeMngRequest
...
#Region "Constructor"
		...
		''' <param name="proposeNumber">The propose number.</param>
		Public Sub New(ByVal sender As Object,
									 ByVal usNr As Integer,
									 ByVal mdNr As Integer,
									 ByVal proposeNumber As Integer)
			MyBase.New(sender)

			m_USNr = usNr
			m_MDNr = mdNr
			m_ProposeNumber = proposeNumber
...
#Region "Public Properties"
		...
		''' </summary>
		''' <returns>The propose number</returns>
		Public ReadOnly Property ProposeNumber As Integer
			Get
				Return m_ProposeNumber
			End Get
		End Property
