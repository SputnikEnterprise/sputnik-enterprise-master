...
Namespace UI
	...
	Partial Class frmReportDropIn
		...
		Private Sub InitializeComponent()
			...
			Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmReportDropIn))
			...
			Me.lblOpenFile.Appearance.Options.UseFont = True
			Me.lblOpenFile.Appearance.Options.UseForeColor = True
			Me.lblOpenFile.Appearance.Options.UseImage = True
			Me.lblOpenFile.Appearance.Options.UseTextOptions = True
			...
			Me.lblOpenFile.Text = "Stattdessen nach Dateien suchen"
			'
			'lblInfo
			'
			...
			Me.lblInfo.Text = "Gescannte Dokumente hierhin ziehen..."
			'
			'frmReportDropIn
			'
			Me.AllowDrop = True
			...
			Me.Name = "frmReportDropIn"
			Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
			Me.Text = "Scan Drop-In"
			Me.TopMost = True
