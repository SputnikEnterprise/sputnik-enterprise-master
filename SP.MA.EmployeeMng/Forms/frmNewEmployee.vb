...
#Region "Private Methods"
		...
		Private Sub TranslateControls()
			...
			pageAdditionalData1.DescriptionText = m_Translate.GetSafeTranslationValue("Bitte geben Sie Eigenschaften und Merkmale sowie die Qualifikation ein")
		...
		Private Sub OnfrmNewEmployee_VisibleChanged(sender As System.Object, e As System.EventArgs) Handles MyBase.VisibleChanged
		...
		Private Sub OnWizardCtrl_FinishClick(sender As System.Object, e As System.ComponentModel.CancelEventArgs) Handles wizardCtrl.FinishClick
			...
			If (ValidateData()) Then
				...
				.ForeignCategory = additionalData2.ForeignCategory,
				.PermissionToDate = additionalData2.PermissionToDate,
				.BirthPlace = additionalData2.BirthPlace,
				.CHPartner = additionalData2.CHPartner,
				.ValidatePermissionWithTax = True,
				.NoSpecialTax = additionalData2.NoSpecialTax,
				.ZEMISNumber = additionalData2.ZEMISNumber,
				.S_Canton = additionalData2.S_Canton,
				.QSTCommunity = additionalData2.QSTCommunity,
				.TaxCommunityCode = additionalData2.TaxCommunityCode,
				.TaxCommunityLabel = additionalData2.TaxCommunityLabel,
				...
				.EmploymentType = additionalData2.EmploymentType,
				.OtherEmploymentType = additionalData2.OtherEmploymentType,
				.TypeOfStay = additionalData2.TypeofStay,
			  ...
			  .CreatedUserNumber = m_InitializationData.UserData.UserNr
					...
					If success Then
						...
						Dim openEmployeeMng As New OpenEmployeeMngRequest(Me, m_InitializationData.UserData.UserNr, SelectedMDNr, NewlyAddedEmployeeNumber)
