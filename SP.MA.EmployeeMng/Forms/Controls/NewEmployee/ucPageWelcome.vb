...
#Region "Public Methods"
    ...
    Public Overrides Function ValidateData() As Boolean
      ...
      If isValid Then
        ...
        ' Advisor
        Dim mustAdvisorBeSelected As Boolean? = m_Utility.ParseToBoolean(m_ProgPath.GetXMLNodeValue(m_MandantData.GetSelectedMDFormDataXMLFilename(lueMandant.EditValue),
...
#Region "Private Methods"
    ...
    Private Sub SelectDefaultAdvisor()
      ...
      ' Select advisor
      Dim selectadvisorkst As Boolean? = m_Utility.ParseToBoolean(m_ProgPath.GetXMLNodeValue(m_MandantData.GetSelectedMDFormDataXMLFilename(lueMandant.EditValue),
