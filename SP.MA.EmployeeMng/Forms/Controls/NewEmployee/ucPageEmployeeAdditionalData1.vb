...
#Region "Public Methods"
		...
		Public Overrides Function ValidateData() As Boolean
			...
			Dim mustFstateBeSelected As Boolean? = m_Utility.ParseToBoolean(m_ProgPath.GetXMLNodeValue(m_MandantData.GetSelectedMDFormDataXMLFilename(mdNr),
																 String.Format("{0}/emplyoeefstateselection", FORM_XML_REQUIREDFIEKDS_KEY)), False)
			Dim mustSstateBeSelected As Boolean? = m_Utility.ParseToBoolean(m_ProgPath.GetXMLNodeValue(m_MandantData.GetSelectedMDFormDataXMLFilename(mdNr),
																 String.Format("{0}/emplyoeesstateselection", FORM_XML_REQUIREDFIEKDS_KEY)), False)
			Dim mustContactBeSelected As Boolean? = m_Utility.ParseToBoolean(m_ProgPath.GetXMLNodeValue(m_MandantData.GetSelectedMDFormDataXMLFilename(mdNr),
																 String.Format("{0}/emplyoeecontactselection", FORM_XML_REQUIREDFIEKDS_KEY)), False)
			Dim mustQualificationBeSelected As Boolean? = m_Utility.ParseToBoolean(m_ProgPath.GetXMLNodeValue(m_MandantData.GetSelectedMDFormDataXMLFilename(mdNr),
...
#Region "Private Methods"
		...
		Private Function LoadQualificationCountryDropDownData() As Boolean
			...
			lueCountryQualification.Properties.DropDownRows = Math.Min(20, countryData.Count)
