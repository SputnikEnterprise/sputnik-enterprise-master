...
#Region "Protected Fields"
    ...
    ''' </summary>
    Protected m_UCMediator As INewEmployeeUserControlFormMediator
...
#Region "Public Properties"
    ...
    ''' </summary>
    Public Property UCMediator As INewEmployeeUserControlFormMediator
      Get
        Return m_UCMediator
      End Get
      Set(value As INewEmployeeUserControlFormMediator)
        m_UCMediator = value
      End Set
    End Property
