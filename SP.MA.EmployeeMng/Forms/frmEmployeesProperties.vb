...
#Region "Private Fields"
	...
	Private m_GVPayrollHistorySettingfilenameWithEmployee As String
...
#Region "Constructor"
	...
	Public Sub New(ByVal _setting As SP.Infrastructure.Initialization.InitializeClass,
		...
		m_PayrollDatabaseAccess = New PayrollDatabaseAccess(connectionString, m_InitializationData.UserData.UserLanguage)
		...
		Try
			...
			m_GVPayrollHistorySettingfilenameWithEmployee = String.Format("{0}Properties\Payrollhistory_WithEmployee{1}.xml", GridSettingPath, m_InitializationData.UserData.UserNr)
...
#Region "Private Methods"
	...
	Private Sub ResetImage()
		Try
			employeePicture.Image = m_EmployeeImage
	...
	Private Sub CreateMyNavBar()
		...
		Try
			...
			Dim groupHistoryModule As NavBarGroup = New NavBarGroup(m_Translate.GetSafeTranslationValue("Daten-History"))
			groupHistoryModule.Name = "gNavHistoryJobs"
			Dim nbiShowDataHistory As NavBarItem = New NavBarItem(m_Translate.GetSafeTranslationValue("Daten-History auflisten"))
			nbiShowDataHistory.Name = "Show_Payroll_History"
			...
			Try
				...
				navMain.Groups.Add(groupHistoryModule)
				groupHistoryModule.ItemLinks.Add(nbiShowDataHistory)
				groupHistoryModule.Expanded = True
...
#Region "Reset grids"
	...
	Private Sub ResetHistoryGrid()
		...
		Me.rlblHeader.Text = String.Format("<b><font size=""+6"">{0}</font></b>", m_Translate.GetSafeTranslationValue("Daten-History"))
		...
		Try
			...
			gvEmployeeProperty.Columns.Add(columnID)
			...
			gvEmployeeProperty.Columns.Add(columnEmployeeNumber)
			...
			gvEmployeeProperty.Columns.Add(columnBirthdate)
			...
			columnCivilState.Caption = m_Translate.GetSafeTranslationValue("Zivilstand")
			columnCivilState.Name = "CivilState"
			columnCivilState.FieldName = "CivilState"
			columnCivilState.Visible = True
			gvEmployeeProperty.Columns.Add(columnCivilState)

			Dim columnSocialInsuranceNumber As New DevExpress.XtraGrid.Columns.GridColumn()
			columnSocialInsuranceNumber.Caption = m_Translate.GetSafeTranslationValue("Sozialversicherungsnummer")
			columnSocialInsuranceNumber.Name = "SocialInsuranceNumber"
			columnSocialInsuranceNumber.FieldName = "SocialInsuranceNumber"
			columnSocialInsuranceNumber.Visible = True
			columnSocialInsuranceNumber.BestFit()
			gvEmployeeProperty.Columns.Add(columnSocialInsuranceNumber)
			...
			gvEmployeeProperty.Columns.Add(columnNationality)

			Dim columnPermissionViewData As New DevExpress.XtraGrid.Columns.GridColumn()
			columnPermissionViewData.Caption = m_Translate.GetSafeTranslationValue("Bewilligung")
			columnPermissionViewData.Name = "PermissionViewData"
			columnPermissionViewData.FieldName = "PermissionViewData"
			columnPermissionViewData.Visible = True
			gvEmployeeProperty.Columns.Add(columnPermissionViewData)

			Dim columnForeignCategory As New DevExpress.XtraGrid.Columns.GridColumn()
			columnForeignCategory.Caption = m_Translate.GetSafeTranslationValue("Kategorie")
			columnForeignCategory.Name = "ForeignCategory"
			columnForeignCategory.FieldName = "ForeignCategory"
			columnForeignCategory.Visible = True
			gvEmployeeProperty.Columns.Add(columnForeignCategory)

			Dim columnBirthPlace As New DevExpress.XtraGrid.Columns.GridColumn()
			columnBirthPlace.Caption = m_Translate.GetSafeTranslationValue("Heimatort")
			columnBirthPlace.Name = "BirthPlace"
			columnBirthPlace.FieldName = "BirthPlace"
			columnBirthPlace.Visible = True
			gvEmployeeProperty.Columns.Add(columnBirthPlace)

			Dim columnCHPartner As New DevExpress.XtraGrid.Columns.GridColumn()
			columnCHPartner.Caption = m_Translate.GetSafeTranslationValue("CH-Partner")
			columnCHPartner.Name = "CHPartner"
			columnCHPartner.FieldName = "CHPartner"
			columnCHPartner.Visible = True
			gvEmployeeProperty.Columns.Add(columnCHPartner)

			Dim columnNoSpecialTax As New DevExpress.XtraGrid.Columns.GridColumn()
			columnNoSpecialTax.Caption = m_Translate.GetSafeTranslationValue("Flüchtling-QST")
			columnNoSpecialTax.Name = "NoSpecialTax"
			columnNoSpecialTax.FieldName = "NoSpecialTax"
			columnNoSpecialTax.Visible = True
			gvEmployeeProperty.Columns.Add(columnNoSpecialTax)

			Dim columnZemisNumber As New DevExpress.XtraGrid.Columns.GridColumn()
			columnZemisNumber.Caption = m_Translate.GetSafeTranslationValue("ZEMIS-Nnummer")
			columnZemisNumber.Name = "ZemisNumber"
			columnZemisNumber.FieldName = "ZemisNumber"
			columnZemisNumber.Visible = True
			gvEmployeeProperty.Columns.Add(columnZemisNumber)

			Dim columnTaxViewData As New DevExpress.XtraGrid.Columns.GridColumn()
			columnTaxViewData.Caption = m_Translate.GetSafeTranslationValue("Quellensteuer")
			columnTaxViewData.Name = "TaxViewData"
			columnTaxViewData.FieldName = "TaxViewData"
			columnTaxViewData.Visible = True
			gvEmployeeProperty.Columns.Add(columnTaxViewData)

			Dim columnCommunityViewData As New DevExpress.XtraGrid.Columns.GridColumn()
			columnCommunityViewData.Caption = m_Translate.GetSafeTranslationValue("Gemeinde")
			columnCommunityViewData.Name = "CommunityViewData"
			columnCommunityViewData.FieldName = "CommunityViewData"
			columnCommunityViewData.Visible = True
			gvEmployeeProperty.Columns.Add(columnCommunityViewData)

			Dim columnEmploymentType As New DevExpress.XtraGrid.Columns.GridColumn()
			columnEmploymentType.Caption = m_Translate.GetSafeTranslationValue("Beschäftigungsart")
			columnEmploymentType.Name = "EmploymentType"
			columnEmploymentType.FieldName = "EmploymentType"
			columnEmploymentType.Visible = True
			gvEmployeeProperty.Columns.Add(columnEmploymentType)

			Dim columnOtherEmploymentType As New DevExpress.XtraGrid.Columns.GridColumn()
			columnOtherEmploymentType.Caption = m_Translate.GetSafeTranslationValue("Weitere Beschäftigung")
			columnOtherEmploymentType.Name = "OtherEmploymentType"
			columnOtherEmploymentType.FieldName = "OtherEmploymentType"
			columnOtherEmploymentType.Visible = True
			gvEmployeeProperty.Columns.Add(columnOtherEmploymentType)

			Dim columnTypeofStay As New DevExpress.XtraGrid.Columns.GridColumn()
			columnTypeofStay.Caption = m_Translate.GetSafeTranslationValue("Aufenthaltsart")
			columnTypeofStay.Name = "TypeofStay"
			columnTypeofStay.FieldName = "TypeofStay"
			columnTypeofStay.Visible = True
			gvEmployeeProperty.Columns.Add(columnTypeofStay)

			Dim columnCertificateForResidence As New DevExpress.XtraGrid.Columns.GridColumn()
			columnCertificateForResidence.Caption = m_Translate.GetSafeTranslationValue("Ansässigkeit")
			columnCertificateForResidence.Name = "CertificateForResidence"
			columnCertificateForResidence.FieldName = "CertificateForResidence"
			columnCertificateForResidence.Visible = True
			gvEmployeeProperty.Columns.Add(columnCertificateForResidence)

			Dim columnCertificateForResidenceValidTo As New DevExpress.XtraGrid.Columns.GridColumn()
			columnCertificateForResidenceValidTo.Caption = m_Translate.GetSafeTranslationValue("Dauer")
			columnCertificateForResidenceValidTo.Name = "CertificateForResidenceValidTo"
			columnCertificateForResidenceValidTo.FieldName = "CertificateForResidenceValidTo"
			columnCertificateForResidenceValidTo.Visible = True
			gvEmployeeProperty.Columns.Add(columnCertificateForResidenceValidTo)

			Dim columnAHVCode As New DevExpress.XtraGrid.Columns.GridColumn()
			columnAHVCode.Caption = m_Translate.GetSafeTranslationValue("AHVCode")
			columnAHVCode.Name = "AHVCode"
			columnAHVCode.FieldName = "AHVCode"
			columnAHVCode.Visible = True
			gvEmployeeProperty.Columns.Add(columnAHVCode)

			Dim columnALVCode As New DevExpress.XtraGrid.Columns.GridColumn()
			columnALVCode.Caption = m_Translate.GetSafeTranslationValue("ALVCode")
			columnALVCode.Name = "ALVCode"
			columnALVCode.FieldName = "ALVCode"
			columnALVCode.Visible = True
			gvEmployeeProperty.Columns.Add(columnALVCode)

			Dim columnBVGCode As New DevExpress.XtraGrid.Columns.GridColumn()
			columnBVGCode.Caption = m_Translate.GetSafeTranslationValue("BVGCode")
			columnBVGCode.Name = "BVGCode"
			columnBVGCode.FieldName = "BVGCode"
			columnBVGCode.Visible = True
			gvEmployeeProperty.Columns.Add(columnBVGCode)

			Dim columnKTGPflicht As New DevExpress.XtraGrid.Columns.GridColumn()
			columnKTGPflicht.Caption = m_Translate.GetSafeTranslationValue("KTGPflicht")
			columnKTGPflicht.Name = "KTGPflicht"
			columnKTGPflicht.FieldName = "KTGPflicht"
			columnKTGPflicht.Visible = True
			gvEmployeeProperty.Columns.Add(columnKTGPflicht)

			Dim columnFerienBack As New DevExpress.XtraGrid.Columns.GridColumn()
			columnFerienBack.Caption = m_Translate.GetSafeTranslationValue("Ferien-Rück.")
			columnFerienBack.Name = "FerienBack"
			columnFerienBack.FieldName = "FerienBack"
			columnFerienBack.Visible = True
			gvEmployeeProperty.Columns.Add(columnFerienBack)

			Dim columnFeierBack As New DevExpress.XtraGrid.Columns.GridColumn()
			columnFeierBack.Caption = m_Translate.GetSafeTranslationValue("Feier-Rück.")
			columnFeierBack.Name = "FeierBack"
			columnFeierBack.FieldName = "FeierBack"
			columnFeierBack.Visible = True
			gvEmployeeProperty.Columns.Add(columnFeierBack)

			Dim columnLohn13Back As New DevExpress.XtraGrid.Columns.GridColumn()
			columnLohn13Back.Caption = m_Translate.GetSafeTranslationValue("13.-Rück.")
			columnLohn13Back.Name = "Lohn13Back"
			columnLohn13Back.FieldName = "Lohn13Back"
			columnLohn13Back.Visible = True
			gvEmployeeProperty.Columns.Add(columnLohn13Back)

			Dim columnMAGleitzeit As New DevExpress.XtraGrid.Columns.GridColumn()
			columnMAGleitzeit.Caption = m_Translate.GetSafeTranslationValue("Gleitzeit")
			columnMAGleitzeit.Name = "MAGleitzeit"
			columnMAGleitzeit.FieldName = "MAGleitzeit"
			columnMAGleitzeit.Visible = True
			gvEmployeeProperty.Columns.Add(columnMAGleitzeit)

			Dim columnAHVAnAm As New DevExpress.XtraGrid.Columns.GridColumn()
			columnAHVAnAm.Caption = m_Translate.GetSafeTranslationValue("AHV-Am")
			columnAHVAnAm.Name = "AHVAnAm"
			columnAHVAnAm.FieldName = "AHVAnAm"
			columnAHVAnAm.Visible = False
			gvEmployeeProperty.Columns.Add(columnAHVAnAm)
			...
			Dim columnCreatedFrom As New DevExpress.XtraGrid.Columns.GridColumn()
			columnCreatedFrom.Caption = m_Translate.GetSafeTranslationValue("Durch")
			columnCreatedFrom.Name = "CreatedFrom"
			columnCreatedFrom.FieldName = "CreatedFrom"
			columnCreatedFrom.Visible = True
			gvEmployeeProperty.Columns.Add(columnCreatedFrom)

			Dim columnCreatedUserNumber As New DevExpress.XtraGrid.Columns.GridColumn()
			columnCreatedUserNumber.Caption = m_Translate.GetSafeTranslationValue("CreatedUserNumber")
			columnCreatedUserNumber.Name = "CreatedUserNumber"
			columnCreatedUserNumber.FieldName = "CreatedUserNumber"
			columnCreatedUserNumber.Visible = False
			gvEmployeeProperty.Columns.Add(columnCreatedUserNumber)
...
#Region "Open modules"
	...
	Private Sub OpenSelectedPropose(ByVal proposeNumber As Integer, ByVal mandantnumber As Integer)
		...
		Dim openMng As New OpenProposeMngRequest(Me, m_InitializationData.UserData.UserNr, mandantnumber, proposeNumber)
		hub.Publish(openMng)
	...
	Private Sub OpenSelectedPayroll(ByVal payrollNumber As Integer, ByVal mandantnumber As Integer)
		...
		Dim _settring As New SP.LO.PrintUtility.ClsLOSetting With {.SelectedMDNr = mandantnumber,
																															 .SelectedMANr = New List(Of Integer)(New Integer() {m_EmployeeNumber}),
	...
	Sub DeleteAssignedInvalidPayroll(ByVal payrollNumber As Integer)
		...
		success = success AndAlso m_PayrollDatabaseAccess.DeleteAssignedInvalidPayroll(payrollNumber)
	...
	Sub HandleRowClickForPayroll(ByVal column As String, ByVal dataRow As Object)
		...
		If Not dataRow Is Nothing Then
			...
			If viewData.monat = 0 AndAlso Not viewData.iscomplete Then
				DeleteAssignedInvalidPayroll(viewData.lonr)
...
#Region "Public Methods"
	...
	Public Sub LoadData(ByVal employeeNumber As Integer, ByVal modulName As String, ByVal img As Image)
		...
		Select Case modulName.ToLower
			...
			Case "Show_Payroll_History".ToLower
				Searchedmodul = 8
				ResetHistoryGrid()
				LoadEmployeePayrollhistoriesList(m_EmployeeNumber)
	...
	Public Function LoadEmployeePayrollhistoriesList(ByVal employeeNumber As Integer?) As Boolean

		Dim listOfHistories = m_EmployeeDatabaseAccess.LoadEmployeePayrollHistoryDataForEmployeeMng(employeeNumber)
		If listOfHistories Is Nothing Then
			m_UtilityUI.ShowErrorDialog("Fehler in der History-Abfrage. Bitte versuchen Sie den Vorgang zu einem späteren Zeitpunkt.")
			Return False
		End If

		Dim reportGridData = (From report In listOfHistories
							  Select New EmployeeBackupHistoryData With
								  {.EmployeeNumber = report.EmployeeNumber,
								  .CivilState = report.CivilState,
								  .SocialInsuranceNumber = report.SocialInsuranceNumber,
								  .Nationality = report.Nationality,
								  .PermissionCode = report.PermissionCode,
								  .PermissionValidTo = report.PermissionValidTo,
								  .ForeignCategory = report.ForeignCategory,
								  .BirthPlace = report.BirthPlace,
								  .CHPartner = report.CHPartner,
								  .NoSpecialTax = report.NoSpecialTax,
								  .ZemisNumber = report.ZemisNumber,
								  .TaxCanton = report.TaxCanton,
								  .TaxCode = report.TaxCode,
								  .TaxCommunityLabel = report.TaxCommunityLabel,
								  .TaxCommunityCode = report.TaxCommunityCode,
								  .TaxChurchCode = report.TaxChurchCode,
								  .NumberOfChildren = report.NumberOfChildren,
								  .EmploymentType = report.EmploymentType,
								  .OtherEmploymentType = report.OtherEmploymentType,
								  .TypeofStay = report.TypeofStay,
								  .CertificateForResidence = report.CertificateForResidence,
								  .CertificateForResidenceValidTo = report.CertificateForResidenceValidTo,
								  .Birthdate = report.Birthdate,
								  .AHVCode = report.AHVCode,
								  .ALVCode = report.ALVCode,
								  .BVGCode = report.BVGCode,
								  .KTGPflicht = report.KTGPflicht,
								  .KKPflicht = report.KKPflicht,
								  .FerienBack = report.FerienBack,
								  .FeierBack = report.FeierBack,
								  .Lohn13Back = report.Lohn13Back,
								  .MAGleitzeit = report.MAGleitzeit,
								  .AHVAnAm = report.AHVAnAm,
								  .CreatedFrom = report.CreatedFrom,
								  .CreatedOn = report.CreatedOn,
								  .CreatedUserNumber = report.CreatedUserNumber,
								  .ID = report.ID
								  }).ToList()

		Dim listDataSource As BindingList(Of EmployeeBackupHistoryData) = New BindingList(Of EmployeeBackupHistoryData)
		...
		grdEmployeeProperty.DataSource = listDataSource
		bsiRecCount.Caption = listOfHistories.Count

		Return Not listOfHistories Is Nothing
	End Function
...
#Region "GridSettings"
	...
	Private Sub RestoreGridLayoutFromXml()
		...
		Select Case Me.Searchedmodul
			...
			Case 8
				Try
					If File.Exists(m_GVPayrollHistorySettingfilenameWithEmployee) Then gvEmployeeProperty.RestoreLayoutFromXml(m_GVPayrollHistorySettingfilenameWithEmployee)
	...
	Private Sub OngvColumnPositionChanged(sender As Object, e As System.EventArgs)
		...
		Select Case Me.Searchedmodul
			...
			Case 8
				gvEmployeeProperty.SaveLayoutToXml(m_GVPayrollHistorySettingfilenameWithEmployee)
	...
	Private Sub OngvEmployeeProperty_CustomColumnDisplayText(ByVal sender As Object, ByVal e As CustomColumnDisplayTextEventArgs) Handles gvEmployeeProperty.CustomColumnDisplayText
		...
		If e.Column.FieldName = "betragohne" OrElse e.Column.FieldName = "betragex" OrElse e.Column.FieldName = "betragink" OrElse e.Column.FieldName = "mwst1" OrElse
				...
				e.Column.FieldName = "margeohnebvg" OrElse e.Column.FieldName = "betragopen" OrElse e.Column.FieldName = "zebetrag" OrElse e.Column.FieldName = "betrag" Then
