...
Public Class ClsConvert
  ...
  Public Overloads Function ConvListObject2ListOfString(ByRef lst As DevExpress.XtraEditors.ComboBoxEdit) As List(Of String)
    Dim StringList As New List(Of String)

    For i As Integer = 0 To lst.Properties.Items.Count - 1
      StringList.Add(CStr(lst.Properties.Items.Item(i)))
    Next
...
#Region "ADD X to ComboBox"
  ...
  ''' <param name="strngList">Die ListOfString, die in die Listbox geschrieben werden soll.</param>
  Public Overloads Function ConvListOfString2ListObject(ByRef lst As DevExpress.XtraEditors.ComboBoxEdit, _
                                                        ByVal strngList As List(Of String)) As DevExpress.XtraEditors.ComboBoxEdit
    For i As Integer = 0 To strngList.Count - 1
      lst.Properties.Items.Add(strngList.Item(i))
    Next
  ...
  ''' <param name="strngList">Das Stringarray, das in die Listbox geschrieben werden soll.</param>
  Public Overloads Function ConvListOfString2ListObject(ByRef lst As DevExpress.XtraEditors.ComboBoxEdit, _
                                                        ByVal strngList() As String) As DevExpress.XtraEditors.ComboBoxEdit
    For i As Integer = 0 To strngList.Length - 1
      lst.Properties.Items.Add(strngList(i))
    Next
