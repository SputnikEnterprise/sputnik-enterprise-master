...
Namespace UI
	...
	Public Class frmApplicationDetail
		...
		Public Delegate Sub MonthlySalaryDataSavedHandler(ByVal sender As Object, ByVal employeeNumber As Integer, ByVal appID As Integer)
...
#Region "Constructor"
		...
		Public Sub New(ByVal _setting As SP.Infrastructure.Initialization.InitializeClass, ByVal data As ApplicationData)
			...
			'ucDetail.CurrentApplicationData = m_CurrentApplicationData
			'ucDetail.LoadData()

			'pnlDetail.Controls.Add(ucDetail)
			'ucDetail.Dock = Windows.Forms.DockStyle.Fill
...
#Region "load"
		...
		Private Function LoadCheckedAdvisorDropDownData() As Boolean
			...
			Dim advisors = m_CommonDatabaseAccess.LoadAdvisorData()
...
#End Region
		...
		Private Sub OntxtApplicationLabel_ButtonClick(sender As Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles txtApplicationLabel.ButtonClick
			...
			If success Then
				RaiseEvent MonthlySalaryDataSaved(Me, m_CurrentApplicationData.EmployeeID, m_CurrentApplicationData.ID)
		...
		Private Sub OnbtnPropose_Click(sender As Object, e As EventArgs) Handles btnPropose.Click
			...
			If Not IsUserActionAllowed(m_InitializationData.UserData.UserNr, 801) Then m_Logger.LogWarning("No rights...") : Exit Sub

			Try
				Dim obj As New SPProposeUtility.ClsMain_Net(m_InitializationData)
				' TODO: CustomerNumber
				If m_CurrentApplicationData.EmployeeID = 0 Then
					obj.ShowfrmProposal(m_CurrentApplicationData.EmployeeID,
														0,
															0,
														m_CurrentApplicationData.VacancyNumber)
				End If
		...
		Private Function SaveApplicationData() As Boolean
			...
			Dim data = LoadAdvisorWithGuidData(lueAdvisor.EditValue)
			...
			m_CurrentApplicationData.Advisor = data.UserGuid
