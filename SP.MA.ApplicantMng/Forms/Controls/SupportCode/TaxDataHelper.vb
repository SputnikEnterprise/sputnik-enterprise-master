...
#Region "Privte Fields"
  ...
  Private m_QstTranslations As IEnumerable(Of QSTData)
  Private m_ChurchTaxCodeTranslations As IEnumerable(Of ChurchTaxCodeData)
#End Region
...
#Region "Public Properties and Methods"
  ...
  Public Function GetTranslationForCode(ByVal qstCode As String) As String
    ...
    Dim translation = (From t In m_QstTranslations
                       Where t.GetField = qstCode
                       Select t.TranslatedQSTCodeText).FirstOrDefault()
  ...
  Public Function GetTranslationForChurchTaxCode(ByVal churchTaxCode As String) As String
    ...
    Dim translation = (From t In m_ChurchTaxCodeTranslations
                       Where t.Code = churchTaxCode
                       Select t.TranslateChurchCodeText).FirstOrDefault()
