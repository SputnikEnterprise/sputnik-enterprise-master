...
Imports SP.MA.ApplicantMng.SPALKUtilWebService
...
#Region "Private Consts"
		...
		Public Const MANDANT_XML_SETTING_SPUTNIK_ALK_UTIL_WEBSERVICE_URI As String = "MD_{0}/Interfaces/webservices/webservicealkdatabase"
		Public Const DEFAULT_SPUTNIK_ALK_UTIL_WEBSERVICE_URI As String = "wssps_services/spalkutil.asmx"
...
#Region "Public Methods"
		...
		Public Overrides Sub Reset()
			...
			chkFrameWorkContractSubscribed.Enabled = IsUserActionAllowed(m_InitializationData.UserData.UserNr, 131, m_InitializationData.MDData.MDNr)
...
#Region "Private Methods"
		...
		Private Function LoadEmployeeDropDownData() As Boolean
			...
			'Dim listDataSource = New List(Of ALKSearchViewData)

			'Dim webservice As New SPALKUtilWebService.SPALKUtilSoapClient
			...
			'Next
			'lueEmployeeALK.Properties.DataSource = listDataSource
