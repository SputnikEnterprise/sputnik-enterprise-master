...
#Region "Private Methods"
					...
					Select Case column.Name.ToLower
						...
						Case Else
							If viewData.DocumentRecordNumber > 0 Then
								ShowDocumentDetailForm(m_EmployeeNumber, viewData.DocumentRecordNumber)
		...
		Private Sub OnBtnAddDocument_Click(sender As System.Object, e As System.EventArgs) Handles btnAddDocument.Click
			If (IsEmployeeDataLoaded) Then
				ShowDocumentDetailForm(m_EmployeeNumber, Nothing)
			End If
		End Sub
		...
		Private Sub ShowDocumentDetailForm(ByVal employeeNumber As Integer, ByVal documentRecordNumber As Integer?)
		...
		Private Sub OnCV_DoubleClick(sender As System.Object, e As System.EventArgs) Handles gvCV.DoubleClick
			...
			If (selectedRows.Count > 0) Then
				...
				ShowCVDetailForm(m_EmployeeNumber, cvData.Name)
			End If
		End Sub
		...
		Private Sub OnBtnAddCV_Click(sender As System.Object, e As System.EventArgs) Handles btnAddCV.Click
			If (IsEmployeeDataLoaded) Then
				ShowCVDetailForm(m_EmployeeNumber, Nothing)
			End If
		End Sub
		...
		Private Sub ShowCVDetailForm(ByVal employeeNumber As Integer, ByVal llName As String)
