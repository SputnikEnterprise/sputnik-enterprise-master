...
#Region "Protected Fields"
    ...
    ''' </summary>
    Protected m_UCMediator As INewInvoiceUserControlFormMediator

		''' <summary>
		''' Communication support between controls.
		''' </summary>
		Protected m_UCPaymentMediator As INewPaymentUserControlFormMediator
...
#Region "Public Properties"
    ...
    ''' </summary>
    Public Property UCMediator As INewInvoiceUserControlFormMediator
      Get
        Return m_UCMediator
      End Get
      Set(value As INewInvoiceUserControlFormMediator)
        m_UCMediator = value
      End Set
    End Property
		...
		''' Gets or set the UC mediator.
		''' </summary>
		Public Property UCPaymentMediator As INewPaymentUserControlFormMediator
			Get
				Return m_UCPaymentMediator
			End Get
			Set(value As INewPaymentUserControlFormMediator)
				m_UCPaymentMediator = value
			End Set
		End Property
		...
		Public Property PreselectionPaymentData As PreselectionPaymentData
