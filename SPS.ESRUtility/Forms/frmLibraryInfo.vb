...
#Region "Constructor..."
		...
		Public Sub New(ByVal initData As SP.Infrastructure.Initialization.InitializeClass)
...
#End Region
		...
		Private Sub ResetGrid()
			...
			columnFilename.Caption = m_Translate.GetSafeTranslationValue("Filename")
			...
			columnFilelocation.Caption = m_Translate.GetSafeTranslationValue("Filelocation")
			...
			columnFileCreatedon.Caption = m_Translate.GetSafeTranslationValue("Erstellt am")
			...
			columnFileVersion.Caption = m_Translate.GetSafeTranslationValue("Version")
			...
			columnFileProcessArchitecture.Caption = m_Translate.GetSafeTranslationValue("ProcessArchitecture")
