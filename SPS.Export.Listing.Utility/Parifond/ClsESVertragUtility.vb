...
Public Class ClsESVertragUtility
  ...
  Private ReadOnly Property GetSQL2Open() As String
    Get
      ...
      Try
        ...
        End If
				...
				strSqlQuery = "SELECT ES.ID, ES.ESNr, ES.MANr, ES.KDNr, ES.ES_Als, ES.KDZHDNr, ESL.GAVGruppe0, MA.Send2WOS As MAWOS, "
	...
	Function CreateData4ESVertrag() As String
		Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name
		...
		Dim _locSetting As ClsLLESVertragSetting = New ClsLLESVertragSetting With {.DbConnString2Open = _PControlSetting.DbConnString2Open, _
																																						 ...
																																						 .SelectedESNr2Print = 0,
																																							.TranslationData = _PControlSetting.TranslationItems,
																																						 .SelectedMANr2Print = 0}
		_locSetting.IsPrintAsVerleih = False
		_locSetting.JobNr2Print = "4.3"

		' ESVertrag exportieren
		Dim obj As New ClsPrintESVertrag(_locSetting)
		strResult = obj.ExportESVertrag
