...
Public Class ClsEventLog
  ...
  Public Sub WriteToLogFile(ByVal msg As String, _
    ...
    Dim strMyFilename As String = _ClsSettingPath.GetProgLOGFile


    If strFullFilename = "" Then
      strPathForLOGs = _ClsSettingPath.GetProgLOGPath
    Else
    ...
    Try
      ...
      'check the file
      Dim fs As FileStream = New FileStream(_ClsSettingPath.GetProgLOGFile, FileMode.OpenOrCreate, FileAccess.ReadWrite)
      Dim s As StreamWriter = New StreamWriter(fs)
      s.Close()
      fs.Close()

      'log it
      Dim fs1 As FileStream = New FileStream(_ClsSettingPath.GetProgLOGFile, FileMode.Append, FileAccess.Write)
  ...
  Public Sub WriteErrorLogFile(ByVal msg As String, Optional ByVal strFullFilename As String = "")
    If strFullFilename = String.Empty Then strFullFilename = _ClsSettingPath.GetErrorLOGFile
  ...
  Public Sub WriteTempLogFile(ByVal msg As String, Optional ByVal strFullFilename As String = "")
    If strFullFilename = String.Empty Then strFullFilename = _ClsSettingPath.GetProzessLOGFile
  ...
  Sub WriteMainLog(ByVal strFuncName As String)
    Dim objAssInfo As New ClsAssInfo()
    Dim Filename As String = _ClsSettingPath.GetMainProgLOGFile
    Dim strContent As String = String.Format("({0}){2}{1}{2}{3}\{2}{4}{2}{2}{5}{2}({6})", _
                                             _ClsSettingPath.GetUserName, Now, vbTab, _
