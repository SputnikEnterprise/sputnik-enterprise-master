...
Module Api_Code
	...
	Public Function FindMimeFromData(pBC As IntPtr,
		...
		cbSize As Integer,
		<MarshalAs(UnmanagedType.LPWStr)>
		pwzMimeProposed As String,
		dwMimeFlags As Integer,
	...
	Public Function GetMimeFromBytes(data As Byte()) As String
		...
		Dim MimeSampleSize As Integer = 1024 ' 256
	...
	Public ReadOnly MIMETypesDictionary As New Dictionary(Of String, String)() From { _
