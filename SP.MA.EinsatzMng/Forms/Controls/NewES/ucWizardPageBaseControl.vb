...
#Region "Protected Fields"
		...
		''' </summary>
		Protected m_UCMediator As INewESUserControlFormMediator
...
#Region "Public Properties"
		...
		''' </summary>
		Public Property UCMediator As INewESUserControlFormMediator
			Get
				Return m_UCMediator
			End Get
			Set(value As INewESUserControlFormMediator)
				m_UCMediator = value
			End Set
		End Property
