...
#Region "Protected Fields"
    ...
    ''' <summary>
    ''' Contains the customer number of the loaded responsible person.
    ''' </summary>
...
#Region "Public Properties"
    ...
    ''' <summary>
    ''' Boolean flag indicating if responible person data is loaded.
    ''' </summary>
    Public ReadOnly Property IsResponsiblePersonDataLoaded As Boolean
      Get
        Return m_CustomerNumber > 0 AndAlso m_RecordNumber.HasValue
      End Get
...
#Region "Public Methods"
    ...
    Public Overridable Function Activate(ByVal customerNumber As Integer, ByVal recordNumber As Integer?) As Boolean
    ...
    Public Overridable Sub MergeResponsiblePersonMasterData(ByVal responsiblePersonMasterData As ResponsiblePersonMasterData, Optional forceMerge As Boolean = False)
      ' Do not make this method abstract because the WinForms designer does not like that.
      Throw New NotImplementedException("The methods must be overriden by subclass.")
    End Sub
