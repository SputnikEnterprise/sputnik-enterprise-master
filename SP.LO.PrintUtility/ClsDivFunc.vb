...
#Region "Funktionen zur Suche nach Daten..."
  ...
  'Function GetLocalSQLString(ByVal frmTest As frmLOPrint, ByVal iRecID As Integer) As String
  ...
  '  With frmTest
  '    Dim strQuery As String = "//SPSMAAddress/frmMAAddress/SQLString[@ID=" & Chr(34) & _
  ...
  '    Else
  '      sSql = "Select * From MA_SAddress Where "
  '      sSql &= "MANr = @MANr And ModulNr = @ModulNr "
  '      If iRecID > 0 Then sSql &= "And ID = @iRecID "
  '      sSql &= "Order By RecNr"
