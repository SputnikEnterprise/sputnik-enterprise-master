...
Public Class ClsMahnModuls
	Private Shared m_Logger As ILogger = New Logger()

	Private _ClsSetting As New ClsMahnSetting
	Private _ClsProgSetting As New SPProgUtility.ClsProgSettingPath


	Public Sub New(ByVal _setting As ClsMahnSetting)
...
#Region "Funktionen für Kontextmenü..."
	...
	Sub ShowContextMenu4Print(ByVal mgr As DevExpress.XtraBars.BarManager, sender As DevExpress.XtraEditors.DropDownButton)
		...
		Try
			...
			param = cmd.Parameters.AddWithValue("@ModulName", "MahnPrint")
			...
			Try
				While rFrec.Read
					...
					If itm.Name.ToLower = "MahnPrint".ToLower Then
						If Not ModulConstants.UserSecValue(482) Then Continue While
					End If
	...
	Sub ShowContextMenu4New(ByVal mgr As DevExpress.XtraBars.BarManager, sender As DevExpress.XtraEditors.DropDownButton)
		...
		Try
			...
			Dim param As System.Data.SqlClient.SqlParameter
			cmd.CommandType = CommandType.StoredProcedure
			param = cmd.Parameters.AddWithValue("@ModulName", "MahnNew")
			param = cmd.Parameters.AddWithValue("@lang", ModulConstants.UserData.UserLanguage)
			...
			Try
				While rFrec.Read
					...
					If itm.Name.ToLower = "createNewMahn".ToLower Then
						If Not ModulConstants.UserSecValue(480) AndAlso Not ModulConstants.UserSecValue(481) Then Continue While
					End If
	...
	Sub GetMnuItem4New(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs)
		...
		Select Case strMnuName
			Case "createNewMahn".ToLower
				Dim obj As New ClsOpenModul(New ClsSetting With {.SelectedKDNr = Nothing})
				obj.OpenNewMahnForm()
