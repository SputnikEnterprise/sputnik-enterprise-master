...
#Region "Funktionen für Rapporte..."
  ...
  Sub FillMAOpenRP(ByVal grd As DevExpress.XtraGrid.GridControl)
    Dim strMethodeName As String = New System.Diagnostics.StackTrace().GetFrame(0).GetMethod().Name

    Try
      Try
        Me._ClsSetting.gvDetailDisplayMember = "Rapport-Nr."
        grd.DataSource = GetDbData4MARP()
  ...
  Function GetDbData4MARP() As DataTable
    ...
    Try
      ...
      If Me._ClsSetting.Data4SelectedMA Then
        strDbQuery = "[Get RPData 4 Selected MA In MainView]"
      Else
        strDbQuery = "[Get RPData 4 All MA In MainView]"
      End If
