...
Public Class ClsMain_Net
	...
	'Sub ShowfrmMAMassenVersand(ByVal iMANr As Long)
	'Dim frmMailing As frmMAMassenversand

	'  ClsDataDetail.GetMANumber = iMANr

	'frmMailing = New frmMAMassenversand(ClsDataDetail.m_InitialData)
	'  frmMailing.Show()

	'End Sub

	Sub ShowfrmMABerufgruppe(ByVal iMANr As Long)
		Dim frmGruppe As frmMABerufgruppe

    ClsDataDetail.GetMANumber = iMANr

		frmGruppe = New frmMABerufgruppe(ClsDataDetail.m_InitialData)
    frmGruppe.Show()
