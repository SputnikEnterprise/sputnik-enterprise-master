...
Namespace RichEditSendMail
	...
	Partial Class frmInvoiceEMailMerge
		...
		Private Sub InitializeComponent()
			...
			Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmInvoiceEMailMerge))
			...
			'
			Me.accordionControlElement23.Elements.AddRange(New DevExpress.XtraBars.Navigation.AccordionControlElement() {Me.aceSender, Me.aceStaging, Me.aceSmtpServer, Me.AccordionControlSeparator3})
			...
			'aceSender
			'
			Me.aceSender.ImageOptions.Image = Global.SPSSendMail.My.Resources.Resources.user_16x161
			...
			'aceSendResult
			'
			Me.aceSendResult.Appearance.Normal.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Bold)
			Me.aceSendResult.Appearance.Normal.Options.UseFont = True
			...
			Me.ImageCollection1.InsertImage(Global.SPSSendMail.My.Resources.Resources.sendpdf_16x16, "sendpdf_16x16", GetType(Global.SPSSendMail.My.Resources.Resources), 7)
			Me.ImageCollection1.Images.SetKeyName(7, "sendpdf_16x16")
			Me.ImageCollection1.Images.SetKeyName(8, "compress-icon.png")
			Me.ImageCollection1.Images.SetKeyName(9, "File-PDF-icon.png")
			'
			'GroupBox1
			'
			...
			Me.lblFormImage.Text = "  EMail-Versand von Rechnungen"
			'
			'btnClose
			'
			...
			Me.IconOptions.Icon = CType(resources.GetObject("frmInvoiceEMailMerge.IconOptions.Icon"), System.Drawing.Icon)
