...
Module FuncOpenProg
  ...
  Sub GetMenuItems4Export(ByVal tsbMenu As ToolStripDropDownButton)
    ...
    Catch ex As Exception ' Manager
      MessageBoxShowError("GetMenuItems4Export", ex)
...
#Region "Funktionen für Exportieren..."
  ...
  Sub RunOpenLOForm(ByVal iLONr As Integer, ByVal iLP As Integer, ByVal iJahr As Integer)
    ...
    Catch ex As Exception ' Manager
      MessageBoxShowError("RunOpenLOForm", ex)
  ...
  Sub RunOpenMAForm(ByVal iMANr As Integer)
    ...
    Catch ex As Exception ' Manager
      MessageBoxShowError("RunOpenMAForm", ex)
  ...
  Sub RunOpenKDform(ByVal iKDNr As Integer)
    ...
    Catch ex As Exception ' Manager
      MessageBoxShowError("RunOpenKDForm", ex)
  ...
  Sub RunOpenESForm(ByVal iESNr As Integer)
    ...
    Catch ex As Exception ' Manager
      MessageBoxShowError("RunOpenMESForm", ex)
  ...
  Private Function ShowMyFileDlg(ByVal strFile2Search As String) As String
    ...
    If openFileDialog1.ShowDialog() = DialogResult.OK Then
      ...
      Catch ex As Exception ' Manager
        MessageBoxShowError("ShowMyFileDlg", ex)
