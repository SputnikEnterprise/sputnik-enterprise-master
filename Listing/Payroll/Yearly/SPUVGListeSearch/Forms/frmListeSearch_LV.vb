...
#End Region
		...
		Try
			...
			If (Not reader Is Nothing) Then
				...
				While reader.Read()
					...
					overviewData.ablp = m_utility.SafeGetInteger(reader, "monatvon", Nothing)
					overviewData.bislp = m_utility.SafeGetInteger(reader, "monatbis", Nothing)
					...
					overviewData.suvalohn = m_utility.SafeGetDecimal(reader, "suvalohn", Nothing)

					overviewData.ahvnr = m_utility.SafeGetString(reader, "ahv_nr_new", Nothing)
	...
	Private Sub ResetGridSalaryData()
		...
		columnsuvabasis.Caption = m_Translate.GetSafeTranslationValue("Suvabasis")
		...
		columnsuvabasis.SummaryItem.Tag = "Sumsuvabasis"
		gvRP.Columns.Add(columnsuvabasis)

		Dim columnsuvalohn As New DevExpress.XtraGrid.Columns.GridColumn()
		columnsuvalohn.Caption = m_Translate.GetSafeTranslationValue("Suvalohn")
		columnsuvalohn.Name = "suvalohn"
		columnsuvalohn.FieldName = "suvalohn"
		columnsuvalohn.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
		columnsuvalohn.AppearanceHeader.Options.UseTextOptions = True
		columnsuvalohn.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
		columnsuvalohn.DisplayFormat.FormatString = "N2"
		columnsuvalohn.Visible = True
		columnsuvalohn.BestFit()
		columnsuvalohn.SummaryItem.DisplayFormat = "{0:n2}"
		columnsuvalohn.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum
		columnsuvalohn.SummaryItem.Tag = "Sumsuvalohn"
		gvRP.Columns.Add(columnsuvalohn)
...
#End Region
	...
	Private Sub OnGV_CustomColumnDisplayText(ByVal sender As Object, ByVal e As CustomColumnDisplayTextEventArgs) Handles gvRP.CustomColumnDisplayText
		...
		If e.Column.FieldName = "bruttolohn" Or e.Column.FieldName = "suvabasis" Or e.Column.FieldName = "suvalohn" Then
	...
	Private Sub OngvColumnPositionChanged(sender As Object, e As System.EventArgs)
		...
		gvRP.OptionsView.ShowFooter = (gvRP.Columns("bruttolohn").Visible OrElse gvRP.Columns("suvabasis").Visible OrElse gvRP.Columns("suvalohn").Visible )
