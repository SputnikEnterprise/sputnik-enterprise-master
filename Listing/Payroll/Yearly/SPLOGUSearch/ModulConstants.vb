...
Public Class InitializeClass
  ...
  Public PersonalizedData As Dictionary(Of String, ClsProsonalizedData)
...
Public Class ModulConstants
  ...
  Public Shared UserData As New SPProgUtility.ClsUserData
	...
	Public Shared TranslateValues As SP.Infrastructure.Initialization.TranslateValuesHelper
  ...
  ''' <returns></returns>
  ''' <remarks></remarks>
  Public Shared ReadOnly Property PersonalizedValues() As Dictionary(Of String, ClsProsonalizedData)
    Get
      Try
  ...
  Function GetSafeTranslationValue(ByVal dicKey As String, ByVal bCheckPersonalizedItem As Boolean) As String
    ...
    Try
      If bCheckPersonalizedItem Then
        If ModulConstants.PersonalizedData.ContainsKey(dicKey) Then
          strPersonalizedItem = ModulConstants.PersonalizedData.Item(dicKey).CaptionValue
