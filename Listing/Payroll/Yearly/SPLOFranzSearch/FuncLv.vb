...
#Region "Dropdown-Funktionen für 1. Seite..."
	...
	Sub ListEmployeeCanton(ByVal cbo As DevExpress.XtraEditors.ComboBoxEdit, ByVal year As Integer)
		Dim m_utility As New SPProgUtility.MainUtilities.Utilities

		Dim strSqlQuery As String = "[List Employee Canton With Mandant]"
		Dim Conn As SqlConnection = New SqlConnection(m_InitialData.MDData.MDDbConn)
		...
		Try
			...
			param = cmd.Parameters.AddWithValue("@MDNr", m_InitialData.MDData.MDNr)
			param = cmd.Parameters.AddWithValue("@Year", m_utility.ReplaceMissing(year, 0))

			Dim reader As SqlDataReader = cmd.ExecuteReader

			cbo.Properties.Items.Clear()
			While reader.Read
				cbo.Properties.Items.Add(m_utility.SafeGetString(reader, "MA_Kanton", ""))
			End While
	...
	Sub ListEmployeeTaxCanton(ByVal cbo As DevExpress.XtraEditors.ComboBoxEdit, ByVal year As Integer)
		Dim m_utility As New SPProgUtility.MainUtilities.Utilities

		Dim strSqlQuery As String = "[List Employee Tax Canton With Mandant]"
		Dim Conn As SqlConnection = New SqlConnection(m_InitialData.MDData.MDDbConn)
		...
		Try
			...
			cbo.Properties.Items.Clear()
			While reader.Read
				cbo.Properties.Items.Add(m_utility.SafeGetString(reader, "S_Kanton", ""))
			End While
