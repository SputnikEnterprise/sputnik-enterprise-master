...
Public Class ClsDataDetail
  ...
  Public Shared strLOAGData As String = String.Empty

  Public Shared _strButtonValue As ButtonValue = ButtonValue.Arbeitgeberlohnart
  Public Shared _Get4What As What = What.MANR

  Public Shared frmLOAG As Form
  ...
  Public Shared GetFilterBez4 As String = String.Empty
    ...
    Get
      Return "86DA8AE5-06B7-4bb6-ACF1-BF57835D8D72"
    End Get
  End Property
  ...
  Public Shared Property StrButtonValue(Optional ByVal button As ButtonValue = ButtonValue.Arbeitgeberlohnart) As ButtonValue
    Get
...
#End Region
  ...
  '// DataTable (Entweder Arbeitgeberlohnart oder Lohnartenrekapitulation)
  Shared _dtSelected As DataTable
  Public Shared Property SelectedDataTable() As DataTable
    Get
      If _dtSelected Is Nothing Then
