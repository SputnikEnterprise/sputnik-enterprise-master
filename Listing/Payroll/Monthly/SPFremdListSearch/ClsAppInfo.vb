...
Public Class ClsAssInfo
  ...
  Public ReadOnly Property Company() As String Implements IAssInfo.Company
    Get
      ...
      m_Company = CType(m_AssInfo.GetCustomAttributes(GetType(SR.AssemblyCompanyAttribute), False)(0), Reflection.AssemblyCompanyAttribute)
  ...
  Public ReadOnly Property Copyright() As String Implements IAssInfo.Copyright
    Get
      ...
      m_Copyright = CType(m_AssInfo.GetCustomAttributes(GetType(SR.AssemblyCopyrightAttribute), False)(0), Reflection.AssemblyCopyrightAttribute)
  ...
  Public ReadOnly Property Description() As String Implements IAssInfo.Description
    Get
      ...
      m_Description = CType(m_AssInfo.GetCustomAttributes(GetType(SR.AssemblyDescriptionAttribute), False)(0), Reflection.AssemblyDescriptionAttribute)
  ...
  Public ReadOnly Property Product() As String Implements IAssInfo.Product
    Get
      ...
      m_Product = CType(m_AssInfo.GetCustomAttributes(GetType(SR.AssemblyProductAttribute), False)(0), Reflection.AssemblyProductAttribute)
  ...
  Public ReadOnly Property Title() As String Implements IAssInfo.Title
    Get
      ...
      m_Title = CType(m_AssInfo.GetCustomAttributes(GetType(SR.AssemblyTitleAttribute), False)(0), Reflection.AssemblyTitleAttribute)
  ...
  Public ReadOnly Property Trademark() As String Implements IAssInfo.Trademark
    Get
      ...
      m_Trademark = CType(m_AssInfo.GetCustomAttributes(GetType(SR.AssemblyTrademarkAttribute), False)(0), Reflection.AssemblyTrademarkAttribute)
