...
Public Class ClsMain_Net
  Public Shared frmTest As frmBruttolohnjournal
  ...
  End Sub
	...
	Sub ShowfrmBruttolohnjournal()
		Dim _clsEventlog As New SPProgUtility.ClsEventLog

		_clsEventlog.WriteMainLog("SPBruttolohnjournal")

		frmTest = New frmBruttolohnjournal(ClsDataDetail.m_InitialData)
		frmTest.Show()
