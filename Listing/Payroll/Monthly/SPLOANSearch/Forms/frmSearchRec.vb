...
Public Class frmSearchRec
	...
	Dim strValueSeprator As String = "#@"
...
#Region "Constructor"
	...
	Public Sub New(ByVal _SearchCriteria As SearchCriteria, ByVal _fieldname As String)
...
#End Region
	...
	Public ReadOnly Property iListeValue(ByVal strValue As String) As String

		Get
			Dim strBez As String = String.Empty

			strBez = _ClsData.GetSelektion
			ClsDataDetail.strLOANData = strBez
