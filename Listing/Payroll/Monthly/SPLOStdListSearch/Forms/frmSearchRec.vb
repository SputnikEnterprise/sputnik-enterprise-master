...
#End Region
	...
	Private Sub frmDataSel_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
		...
		Try
			Me.KeyPreview = True
			Dim strStyleName As String = m_mandant.GetSelectedUILayoutName(ClsDataDetail.m_InitialData.MDData.MDNr, ClsDataDetail.m_InitialData.UserData.UserNr, String.Empty)
		...
		End Try
		If SelectedYear = 0 Then SelectedYear = Now.Year
...
#Region "Datenbankabfragen für SearchRec..."
	...
	Function GetMADbData4QSTSearch() As DataTable
		...
		Dim strQuery As String = "[List MAData For Search ArbeitsstundenSearchList]"
		...
		param = cmd.Parameters.AddWithValue("@Year", SelectedYear)
