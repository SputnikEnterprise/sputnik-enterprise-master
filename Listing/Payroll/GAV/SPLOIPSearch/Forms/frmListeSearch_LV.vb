...
#End Region
		...
		Try
			...
			If (Not reader Is Nothing) Then
				...
				While reader.Read()
					...
					'Select Case AnzahlStd, BeitragLohnAG, Lohnsumme, GAV_VAG_S, GAV_VAN_S, GAV_WAG_S, GAV_WAN_S, GAV_VAG, GAV_VAN, GAV_WAG, GAV_WAN, Pauschale, MANr, Nachname, Vorname, Jahrgang, GebDat, AHV_Nr 
					...
					overviewData.GAV_VAG_S = m_utility.SafeGetDecimal(reader, "GAV_VAG_S", Nothing)
					overviewData.GAV_VAN_S = m_utility.SafeGetDecimal(reader, "GAV_VAN_S", Nothing)
					overviewData.GAV_WAG_S = m_utility.SafeGetString(reader, "GAV_WAG_S", Nothing)
					overviewData.GAV_WAN_S = m_utility.SafeGetString(reader, "GAV_WAN_S", Nothing)

					overviewData.GAV_VAG = m_utility.SafeGetDecimal(reader, "GAV_VAG", Nothing)
					overviewData.GAV_VAN = m_utility.SafeGetDecimal(reader, "GAV_VAN", Nothing)
					overviewData.GAV_WAG = m_utility.SafeGetString(reader, "GAV_WAG", Nothing)
					overviewData.GAV_WAN = m_utility.SafeGetString(reader, "GAV_WAN", Nothing)
	...
	Private Function LoadFoundedSalaryList() As Boolean
		...
		Dim responsiblePersonsGridData = (From person In listOfEmployees
					 ...
					 {.MDNr = person.MDNr,
						...
						.ablp = person.ablp,
						.bislp = person.bislp,
						.GAV_VAG_S = person.GAV_VAG_S,
						.GAV_VAN_S = person.GAV_VAN_S,
						.GAV_WAG_S = person.GAV_WAG_S,
						.GAV_WAN_S = person.GAV_WAN_S,
						.GAV_VAG = person.GAV_VAG,
						.GAV_VAN = person.GAV_VAN,
						.GAV_WAG = person.GAV_WAG,
						.GAV_WAN = person.GAV_WAN,
	...
	Private Sub ResetGridSalaryData()
		...
		Dim columnWAGAN_S As New DevExpress.XtraGrid.Columns.GridColumn()
		columnWAGAN_S.Caption = m_Translate.GetSafeTranslationValue("Weiterbildung AG-AN (Stunde)")
		columnWAGAN_S.Name = "WAGAN_S"
		columnWAGAN_S.FieldName = "WAGAN_S"
		columnWAGAN_S.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
		columnWAGAN_S.AppearanceHeader.Options.UseTextOptions = True
		columnWAGAN_S.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
		columnWAGAN_S.DisplayFormat.FormatString = "N2"
		columnWAGAN_S.Visible = True
		columnWAGAN_S.BestFit()
		gvRP.Columns.Add(columnWAGAN_S)

		Dim columnWAGAN As New DevExpress.XtraGrid.Columns.GridColumn()
		columnWAGAN.Caption = m_Translate.GetSafeTranslationValue("Weiterbildung AG-AN (%)")
		columnWAGAN.Name = "WAGAN"
		columnWAGAN.FieldName = "WAGAN"
		columnWAGAN.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
		columnWAGAN.AppearanceHeader.Options.UseTextOptions = True
		columnWAGAN.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
		columnWAGAN.DisplayFormat.FormatString = "N2"
		columnWAGAN.Visible = True
		columnWAGAN.BestFit()
		gvRP.Columns.Add(columnWAGAN)

		Dim columnVAGAN_S As New DevExpress.XtraGrid.Columns.GridColumn()
		columnVAGAN_S.Caption = m_Translate.GetSafeTranslationValue("Vollzug AG-AN (Stunde)")
		columnVAGAN_S.Name = "VAGAN_S"
		columnVAGAN_S.FieldName = "VAGAN_S"
		columnVAGAN_S.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
		columnVAGAN_S.AppearanceHeader.Options.UseTextOptions = True
		columnVAGAN_S.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
		columnVAGAN_S.DisplayFormat.FormatString = "N2"
		columnVAGAN_S.Visible = True
		columnVAGAN_S.BestFit()
		gvRP.Columns.Add(columnVAGAN_S)

		Dim columnVAGAN As New DevExpress.XtraGrid.Columns.GridColumn()
		columnVAGAN.Caption = m_Translate.GetSafeTranslationValue("Vollzug AG-AN (%)")
		columnVAGAN.Name = "VAGAN"
		columnVAGAN.FieldName = "VAGAN"
		columnVAGAN.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far
		columnVAGAN.AppearanceHeader.Options.UseTextOptions = True
		columnVAGAN.DisplayFormat.FormatType = DevExpress.Utils.FormatType.Numeric
		columnVAGAN.DisplayFormat.FormatString = "N2"
		columnVAGAN.Visible = True
		columnVAGAN.BestFit()
		gvRP.Columns.Add(columnVAGAN)
		...
		columnbeitraglohnan.SummaryItem.Tag = "Sumbeitraglohnag"
...
#End Region
	...
	Private Sub OnGV_CustomColumnDisplayText(ByVal sender As Object, ByVal e As CustomColumnDisplayTextEventArgs) Handles gvRP.CustomColumnDisplayText
		...
		If e.Column.FieldName = "lohnsumme" Or e.Column.FieldName = "anzahlstd" Or e.Column.FieldName = "GAV_VAG_S" Or e.Column.FieldName = "beitraglohnag" Then
	...
	Private Sub OngvColumnPositionChanged(sender As Object, e As System.EventArgs)
		...
		gvRP.OptionsView.ShowFooter = (gvRP.Columns("lohnsumme").Visible OrElse gvRP.Columns("anzahlstd").Visible OrElse gvRP.Columns("GAV_VAG_S").Visible OrElse
