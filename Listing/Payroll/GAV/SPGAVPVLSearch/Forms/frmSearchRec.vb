...
Public Class frmSearchRec
	...
	Private m_YearFrom As Integer?
	Private m_YearTo As Integer?
	Private m_MonthFrom As Integer?
	Private m_MonthTo As Integer?


#Region "Constructor"

	Public Sub New(ByVal _fieldname As String, ByVal yearFrom As Integer?, ByVal yearTo As Integer?, ByVal monthFrom As Integer?, ByVal monthTo As Integer?)
...
#Region "Datenbankabfragen für SearchRec..."
	...
	Function GetMADbData4Search() As DataTable
		...
		param = cmd.Parameters.AddWithValue("@MonthFrom", m_MonthFrom.GetValueOrDefault(0))
		param = cmd.Parameters.AddWithValue("@MonthTo", m_MonthTo.GetValueOrDefault(0))
		param = cmd.Parameters.AddWithValue("@YearFrom", m_YearFrom.GetValueOrDefault(0))
		param = cmd.Parameters.AddWithValue("@YearTo", m_YearTo.GetValueOrDefault(0))
